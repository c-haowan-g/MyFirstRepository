 ...
 */
public class PlmMixRecipeEditExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixRecipeEditServiceImpl service = (PlmMixRecipeEditServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixRecipeEditServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixRecipeEditServiceImpl"));
