 ...
 */
@ATDefinition("D_QM_TYREREASCOUNT")
@Entity
@XmlRootElement
@Table(name="AT_D_QM_TYREREASCOUNT")
public class TyreReasCountRecord extends RockWellBaseEntity{
    ...
    public String getArch_flag1_s(){
        return arch_flag1_s;
    }
    
    @XmlElement
    public void setArch_flag1_s(String arch_flag1_s){
        this.arch_flag1_s=arch_flag1_s;
    }
    ...
    public Date getSort_time_t(){
        return sort_time_t;
    }
    
    @XmlElement
    public void setSort_time_t(Date sort_time_t){
        this.sort_time_t=sort_time_t;
    }
