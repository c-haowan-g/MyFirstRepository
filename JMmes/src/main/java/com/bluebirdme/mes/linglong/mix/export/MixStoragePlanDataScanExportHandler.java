 ...
 */
public class MixStoragePlanDataScanExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixStoragePlanDataScanServiceImpl service = (MixStoragePlanDataScanServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixStoragePlanDataScanServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixStoragePlanDataScanServiceImpl"));
