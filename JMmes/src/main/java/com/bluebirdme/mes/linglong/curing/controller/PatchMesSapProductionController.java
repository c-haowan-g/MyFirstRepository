...
import com.bluebirdme.mes.linglong.curing.service.PatchMesSapProductionServiceImpl;

/**
 * 产量固化与SAP抛帐
 *
 * @author 孙尊龙
 * @Date 2020-05-22 14:23:44
 */
@Log(code = "AT_INT_SAP_MESSAPPRODUCTION_LOG", value = "产量固化与SAP抛帐日志")
@RestController
@RequestMapping("curing/patchmesapproduction")
public class PatchMesSapProductionController extends RockWellFunctionalUDAController<Object> {

    @Resource
    PatchMesSapProductionServiceImpl patchmessapproductionSrv;

    @Override
    protected RockWellBaseServiceImpl<Object> getService() {
        return patchmessapproductionSrv;
    }
    ...
    public Response saveVersion(@RequestBody List<MesSapProduction> list) throws Exception {
        String message=patchmessapproductionSrv.saveVersion(list);
    ...
    public String searchBy(String post_date_s,String batch_id_s,String material_code_s,String class_id_s,String operate_usernane_s,String serid_s,String product_type_s,String process_s) throws Exception{
        ...
        List<Map<String, Object>> list = patchmessapproductionSrv.searchBy(filter);
