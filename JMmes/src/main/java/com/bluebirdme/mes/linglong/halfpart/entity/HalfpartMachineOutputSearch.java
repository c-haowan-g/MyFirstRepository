...
public class HalfpartMachineOutputSearch extends RockWellBaseEntity{
    ...
    */
    ...
    @Comment("生产版本")
    @Column(nullable=true,length=80)
    private String productionversion_s;
   ...
   /* public String getColumn_11_s(){
    ...
    public String getProductionversion_s(){
        return productionversion_s;
    }
    
    @XmlElement
    public void setProductionversion_s(String productionversion_s){
        this.productionversion_s=productionversion_s;
    }
