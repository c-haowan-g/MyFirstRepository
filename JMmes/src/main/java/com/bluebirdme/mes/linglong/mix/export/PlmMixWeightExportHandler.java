 ...
 */
public class PlmMixWeightExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixWeightServiceImpl service = (PlmMixWeightServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixWeightServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixWeightServiceImpl"));
