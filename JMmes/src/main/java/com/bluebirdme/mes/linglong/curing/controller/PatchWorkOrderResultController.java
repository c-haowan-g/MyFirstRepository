...
import com.bluebirdme.mes.linglong.curing.service.PatchWorkOrderResultServiceImpl;

/**
 * 生产明细查询
 * @author 孙尊龙
 * @Date 2018-5-22 14:45:20
 */
@Log(code="WorkOrderResult",value="WorkOrderResult")
@RestController
@RequestMapping("curing/report/patchProductionSubsidiaryQuery")
public class PatchWorkOrderResultController extends RockWellFunctionalUDAController<Object> {

    @Resource PatchWorkOrderResultServiceImpl patchworkorderresultSrv;

    @Override
    protected RockWellBaseServiceImpl<Object> getService() {
        return patchworkorderresultSrv;
    }
    @Override
    ...
    public String searchBy(Filter filter, Page page)throws Exception {
        if(filter.get("tyre_barcode_s")==null){
            Map map = patchworkorderresultSrv.datagridTwo(filter, page);
            return toJson(map);
        }else{
            filter.set("end_time", "");
    ...
    /**
     * 产线编码的查询（Equipment表中的equip_code_s）
     * 时永良-2019/7/17
     * @return
     */
    @RequestMapping("searchByEquipCode")
    public String searchByModal() {
        List<Map<String, Object>> list = patchworkorderresultSrv.searchByEquipCode();
        return toJson(list);
    }

    /**
     * 查询物料编码（part表中的part_number）
     * 时永良-2019/7/17
     * @return
     */
    @RequestMapping("searchByMaterial")
    public String searchByMaterial() {
        List<Map<String, Object>> list = patchworkorderresultSrv.searchByMaterial();
        return toJson(list);
    }
    /**
     * 获取硫化曲线数据
    ...
    public String lhqx(@RequestBody Map<String,Object> list_map){
        List<Map<String, Object>> listDate = patchworkorderresultSrv.lhqx(list_map);
    ...
    public String dxyl(@RequestBody Map<String,Object> list_map){
        List<Map<String, Object>> listDate = patchworkorderresultSrv.dxyl(list_map);
        return toJson(listDate);
    }
    ...
    public String searchReportData(Filter filter, Page page)throws Exception {
        filter.set("s_factory_s", LLWebUtils.factory());
        Map list = patchworkorderresultSrv.datagridUDAThree(filter, page);
        return toJson(list);
    }
    /**
    ...
    public Response curing(@RequestBody Map<String,Object> workOrderResultReportDTO) throws Exception {
        String message=patchworkorderresultSrv.curing(workOrderResultReportDTO);
    ...
    public String productionDetail(@RequestBody Map<String,Object> workOrderResultReportDTO) throws Exception {
        List<Map<String,Object>> list=patchworkorderresultSrv.productionDetail(workOrderResultReportDTO);
        return toJson(list);
    }
    ...
    public Response reporttosapBySelectRow(String[] batchidlist) throws Exception{
        patchworkorderresultSrv.reporttosapBySelectRow(batchidlist);
        return Response.suc();
    }
    /**
    ...
    public Response reflushtosapBySelectRow(String[] batchidlist) throws Exception{
        patchworkorderresultSrv.reflushtosapBySelectRow(batchidlist);
        return Response.suc();
    }
    /**
    ...
    public Response repeattosapBySelectRow(String[] batchidlist) throws Exception{
        patchworkorderresultSrv.repeattosapBySelectRow(batchidlist);
        return Response.suc();
    }
    /**
    ...
    public String productionDetail2(@RequestBody Map<String,Object> workOrderResultReportDTO) throws Exception {
        List<Map<String,Object>> list=patchworkorderresultSrv.productionDetail2(workOrderResultReportDTO);
        return toJson(list);
    }
}
