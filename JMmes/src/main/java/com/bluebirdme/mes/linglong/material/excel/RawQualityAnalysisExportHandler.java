 ...
 */
public class RawQualityAnalysisExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	RawQualityAnalysisServiceImpl service = (RawQualityAnalysisServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"RawQualityAnalysisServiceImpl"首字母改为小写
   				.firstCharToLowerCase("RawQualityAnalysisServiceImpl"));
   		...
   		if (entityList != null) {
   			for (int i = 0; i < entityList.size(); i++) {
   				...
   				if(entityList.get(i).get("producername_custom_s")!=null){
   					entityList.get(i).put("producername_custom_s",entityList.get(i).get("producername_custom_s").toString());
   				}
   				if(entityList.get(i).get("suppliername_s")!=null){
   					entityList.get(i).put("suppliername_s",entityList.get(i).get("suppliername_s").toString());
   				}
   				if(entityList.get(i).get("sapcode_s")!=null){
   					entityList.get(i).put("sapcode_s",entityList.get(i).get("sapcode_s").toString());
   				}
   				if(entityList.get(i).get("samplename_s")!=null){
   					entityList.get(i).put("samplename_s",entityList.get(i).get("samplename_s").toString());
   				}
   				if(entityList.get(i).get("finalresult_s")!=null){
   					entityList.get(i).put("finalresult_s",entityList.get(i).get("finalresult_s").toString());
   				}
