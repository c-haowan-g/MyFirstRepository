 ...
 */
public class CheckgradestorageExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	CheckgradestorageServiceImpl shu = (CheckgradestorageServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"CheckgradestorageServiceImpl"首字母改为小写
   				.firstCharToLowerCase("CheckgradestorageServiceImpl"));
