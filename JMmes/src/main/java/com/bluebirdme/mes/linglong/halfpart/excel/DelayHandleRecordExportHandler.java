 ...
 */
public class DelayHandleRecordExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	DelayHandleRecordServiceImpl service = (DelayHandleRecordServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"DelayHandleRecordServiceImpl"首字母改为小写
   				.firstCharToLowerCase("DelayHandleRecordServiceImpl"));
