 ...
 */
@ATDefinition("D_QM_SORTTRIMLOG")
@Entity
@XmlRootElement
@Table(name = "AT_D_QM_SORTTRIMLOG")
public class SortTrimLog extends RockWellBaseEntity {
	...
	@Comment("工控下发备注工控下发是否成功：0-成功、1-失败")
	@Column(nullable = true, length = 80)
