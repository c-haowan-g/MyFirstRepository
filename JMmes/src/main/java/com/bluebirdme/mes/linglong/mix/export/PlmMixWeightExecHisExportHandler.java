 ...
 */
public class PlmMixWeightExecHisExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixWeightExecHisServiceImpl service = (PlmMixWeightExecHisServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"Plm_MixWeightExecHisServiceImpl"首字母改为小写
   				.firstCharToLowerCase("Plm_MixWeightExecHisServiceImpl"));
    ...
    public void regFormatter() {
        ...
        regFormatter("sync_hand_flag_flhand_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //sync_hand_flag_flhand_s
                return null;
            }
        });
        ...
        // 人工配料-数据同步处理反馈
        regFormatter("sync_hand_msg_flhand_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //sync_hand_msg_flhand_s
                return null;
            }
        });
        ...
        // 人工配料-数据同步处理时间
        regFormatter("sync_hand_time_flhand_t", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //sync_hand_time_flhand_t
                return null;
            }
        });
