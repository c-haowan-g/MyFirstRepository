 ...
 */
public class MaterialStoragePlanDataExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MaterialStoragePlanDataServiceImpl service = (MaterialStoragePlanDataServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MaterialStoragePlanDataServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MaterialStoragePlanDataServiceImpl"));
    ...
    public void regFormatter() {
        ...
        // 盘点时库位编码
        regFormatter("inventory_loc_code_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //inventory_loc_code_s
                return null;
            }
        });
        
        // 盘点时库位 
        regFormatter("inventory_loc_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //inventory_loc_s
        ...
        regFormatter("inventory_result_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //inventory_result_s
