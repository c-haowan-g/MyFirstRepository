 ...
 */
public class PlmMixRecipeExecExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixRecipeExecServiceImpl service = (PlmMixRecipeExecServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixRecipeExecServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixRecipeExecServiceImpl"));
