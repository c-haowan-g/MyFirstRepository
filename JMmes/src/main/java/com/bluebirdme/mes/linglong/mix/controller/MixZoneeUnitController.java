...
import com.bluebirdme.mes.linglong.mix.entity.MixZoneeUnit;
import com.bluebirdme.mes.linglong.mix.service.MixZoneeUnitServiceImpl;
...
@RestController
@RequestMapping("mix/basedata/storageunitmanager")
public class MixZoneeUnitController extends FunctionalController<MixZoneeUnit> {

	@Resource
	MixZoneeUnitServiceImpl stoUnitSrv;

	@Override
	protected BaseServiceImpl<MixZoneeUnit> getService() {
		return stoUnitSrv;
	}
