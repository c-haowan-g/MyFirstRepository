 ...
 */
@ATDefinition("C_MM_MAINTYRE_CUR")
@Entity
@XmlRootElement
@Table(name="AT_C_MM_MAINTYRE_CUR")
public class MaintyreCur extends RockWellBaseEntity{
    ...
    @Comment("全钢终检-动平衡分拣备注")
    @Column(nullable=true,length=80)
    private String reserved10_s;
    
    @Comment("全钢终检-入库前分拣去向")
    @Column(nullable=true,length=80)
    private String reserved11_s;
    
    @Comment("全钢终检-入库前分拣备注")
    @Column(nullable=true,length=80)
    private String reserved12_s;
    
    @Comment("预留字段13")
    @Column(nullable=true,length=80)
    private String reserved13_s;
    
    @Comment("预留字段14")
    @Column(nullable=true,length=80)
    private String reserved14_s;
    
    @Comment("预留字段15")
    @Column(nullable=true,length=80)
    private String reserved15_s;
    
    @Comment("预留字段16")
    @Column(nullable=true,length=80)
    private String reserved16_s;
    
    @Comment("预留字段17")
    @Column(nullable=true,length=80)
    private String reserved17_s;
    
    @Comment("预留字段18")
    @Column(nullable=true,length=80)
    private String reserved18_s;
    
    @Comment("预留字段19")
    @Column(nullable=true,length=80)
    private String reserved19_s;
    
    @Comment("全钢终检-割毛分拣去向")
    @Column(nullable=true,length=80)
    private String reserved1_s;
    
    @Comment("预留字段20")
    @Column(nullable=true,length=80)
    private String reserved20_s;
    
    @Comment("全钢终检-割毛分拣备注")
    @Column(nullable=true,length=80)
    private String reserved2_s;
    
    @Comment("全钢终检-外观前分拣去向")
    @Column(nullable=true,length=80)
    private String reserved3_s;
    
    @Comment("全钢终检-外观前分拣备注")
    @Column(nullable=true,length=80)
    private String reserved4_s;
    
    @Comment("全钢终检-外观后分拣去向")
    @Column(nullable=true,length=80)
    private String reserved5_s;
    
    @Comment("全钢终检-外观后分拣备注")
    @Column(nullable=true,length=80)
    private String reserved6_s;
    
    @Comment("全钢终检-X光分拣去向")
    @Column(nullable=true,length=80)
    private String reserved7_s;
    
    @Comment("全钢终检-X光分拣备注")
    @Column(nullable=true,length=80)
    private String reserved8_s;
    
    @Comment("全钢终检-动平衡分拣去向")
    @Column(nullable=true,length=80)
    private String reserved9_s;
    ...
    @Comment("入库等级")
    @Column(nullable=true,length=80)
    private String storage_level_s;
    ...
    public String getReserved10_s(){
        return reserved10_s;
    }
    
    @XmlElement
    public void setReserved10_s(String reserved10_s){
        this.reserved10_s=reserved10_s;
    }
        
    public String getReserved11_s(){
        return reserved11_s;
    }
    
    @XmlElement
    public void setReserved11_s(String reserved11_s){
        this.reserved11_s=reserved11_s;
    }
        
    public String getReserved12_s(){
        return reserved12_s;
    }
    
    @XmlElement
    public void setReserved12_s(String reserved12_s){
        this.reserved12_s=reserved12_s;
    }
        
    public String getReserved13_s(){
        return reserved13_s;
    }
    
    @XmlElement
    public void setReserved13_s(String reserved13_s){
        this.reserved13_s=reserved13_s;
    }
        
    public String getReserved14_s(){
        return reserved14_s;
    }
    
    @XmlElement
    public void setReserved14_s(String reserved14_s){
        this.reserved14_s=reserved14_s;
    }
        
    public String getReserved15_s(){
        return reserved15_s;
    }
    
    @XmlElement
    public void setReserved15_s(String reserved15_s){
        this.reserved15_s=reserved15_s;
    }
        
    public String getReserved16_s(){
        return reserved16_s;
    }
    
    @XmlElement
    public void setReserved16_s(String reserved16_s){
        this.reserved16_s=reserved16_s;
    }
        
    public String getReserved17_s(){
        return reserved17_s;
    }
    
    @XmlElement
    public void setReserved17_s(String reserved17_s){
        this.reserved17_s=reserved17_s;
    }
        
    public String getReserved18_s(){
        return reserved18_s;
    }
    
    @XmlElement
    public void setReserved18_s(String reserved18_s){
        this.reserved18_s=reserved18_s;
    }
        
    public String getReserved19_s(){
        return reserved19_s;
    }
    
    @XmlElement
    public void setReserved19_s(String reserved19_s){
        this.reserved19_s=reserved19_s;
    }
        
    public String getReserved1_s(){
        return reserved1_s;
    }
    
    @XmlElement
    public void setReserved1_s(String reserved1_s){
        this.reserved1_s=reserved1_s;
    }
        
    public String getReserved20_s(){
        return reserved20_s;
    }
    
    @XmlElement
    public void setReserved20_s(String reserved20_s){
        this.reserved20_s=reserved20_s;
    }
        
    public String getReserved2_s(){
        return reserved2_s;
    }
    
    @XmlElement
    public void setReserved2_s(String reserved2_s){
        this.reserved2_s=reserved2_s;
    }
        
    public String getReserved3_s(){
        return reserved3_s;
    }
    
    @XmlElement
    public void setReserved3_s(String reserved3_s){
        this.reserved3_s=reserved3_s;
    }
        
    public String getReserved4_s(){
        return reserved4_s;
    }
    
    @XmlElement
    public void setReserved4_s(String reserved4_s){
        this.reserved4_s=reserved4_s;
    }
        
    public String getReserved5_s(){
        return reserved5_s;
    }
    
    @XmlElement
    public void setReserved5_s(String reserved5_s){
        this.reserved5_s=reserved5_s;
    }
        
    public String getReserved6_s(){
        return reserved6_s;
    }
    
    @XmlElement
    public void setReserved6_s(String reserved6_s){
        this.reserved6_s=reserved6_s;
    }
        
    public String getReserved7_s(){
        return reserved7_s;
    }
    
    @XmlElement
    public void setReserved7_s(String reserved7_s){
        this.reserved7_s=reserved7_s;
    }
        
    public String getReserved8_s(){
        return reserved8_s;
    }
    
    @XmlElement
    public void setReserved8_s(String reserved8_s){
        this.reserved8_s=reserved8_s;
    }
        
    public String getReserved9_s(){
        return reserved9_s;
    }
    
    @XmlElement
    public void setReserved9_s(String reserved9_s){
        this.reserved9_s=reserved9_s;
    }
    ...
    public String getStorage_level_s(){
        return storage_level_s;
    }
    
    @XmlElement
    public void setStorage_level_s(String storage_level_s){
        this.storage_level_s=storage_level_s;
    }
