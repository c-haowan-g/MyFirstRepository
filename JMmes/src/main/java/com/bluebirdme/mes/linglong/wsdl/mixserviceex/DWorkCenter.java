...
/**
 * <p>
 * Java class for DWorkCenter complex type.
 * 
 * <p>
 ...
 *         &lt;element name="defaultEquipmentKey" type="{http://www.w3.org/2001/XMLSchema}long"/>
 *         &lt;element name="defaultEquipmentName" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "DWorkCenter", propOrder = { "capacity", "carrierKeys",
		"connections", "currentStates", "defaultEquipmentKey",
		"defaultEquipmentName", "deletePrivilegeKey", "equipmentKeys",
		"graphInfos", "graphInfosChanged", "locationKey", "locationName",
		"ports", "productionLineKey", "productionLineName",
		"productionQueueKeys", "storageUnitKeys", "sublotAccessType",
		"updatePrivilegeKey", "workInstructionKeys",
		"workInstructionKeysChanged", "workInstructionListKey",
		"workScheduleKey" })
public class DWorkCenter extends DAbstractResource {
	...
	protected long defaultEquipmentKey;
	protected String defaultEquipmentName;
	...
	/**
	 * Gets the value of the defaultEquipmentKey property.
	 * 
	 */
	public long getDefaultEquipmentKey() {
		return defaultEquipmentKey;
	}

	/**
	 * Sets the value of the defaultEquipmentKey property.
	 * 
	 */
	public void setDefaultEquipmentKey(long value) {
		this.defaultEquipmentKey = value;
	}

	/**
	 * Gets the value of the defaultEquipmentName property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	public String getDefaultEquipmentName() {
		return defaultEquipmentName;
	}

	/**
	 * Sets the value of the defaultEquipmentName property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setDefaultEquipmentName(String value) {
		this.defaultEquipmentName = value;
	}
