 ...
 */
public class PlmMixMixEditExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixMixEditServiceImpl service = (PlmMixMixEditServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixMixEditServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixMixEditServiceImpl"));
