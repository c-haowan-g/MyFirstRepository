 ...
 */
public class DrRecordkcExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	DrRecordkcServiceImpl service = (DrRecordkcServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"DrRecordkcServiceImpl"首字母改为小写
   				.firstCharToLowerCase("drRecordkcServiceImpl"));
