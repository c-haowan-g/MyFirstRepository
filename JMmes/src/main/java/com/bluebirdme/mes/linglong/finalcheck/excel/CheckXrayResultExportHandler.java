 ...
 */
public class CheckXrayResultExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	CheckXrayResultServiceImpl service = (CheckXrayResultServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"CheckXrayResultServiceImpl"首字母改为小写
   				.firstCharToLowerCase("CheckXrayResultServiceImpl"));
   		...
   		if (entityList != null) {
   			for (int i = 0; i < entityList.size(); i++) {
   				...
   				if(entityList.get(i).get("usershift_s")!=null){
