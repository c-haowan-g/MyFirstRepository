 ...
 */
public class MixStoragePlanDataScanImportHandler extends ExcelImportHandler {
    ...
    public void toDB(ExcelContent content) throws Exception {
        List<MixStoragePlanDataScan> list=convertToEntityList(MixStoragePlanDataScan.class, content, null);
        MixStoragePlanDataScanServiceImpl mixstorageplandatascanSrv=(MixStoragePlanDataScanServiceImpl)SpringContext.getBean("mixstorageplandatascanServiceImpl");
        mixstorageplandatascanSrv.save(list);
    }
