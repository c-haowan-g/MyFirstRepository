 ...
 */
public class MixStoragePlanDataOutExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixStoragePlanDataOutServiceImpl service = (MixStoragePlanDataOutServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixStoragePlanDataOutServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixStoragePlanDataOutServiceImpl"));
