...
import com.bluebirdme.mes.linglong.halfpart.entity.OutStoreRecord;
...
public class OutStoreRecordServiceImpl extends  RockWellUDABaseServiceImpl<Object> {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> searchTypeByCode(String outtype_s) {
		  SQLQuery query = createSQLQuery(getSQL("searchTypeByCode"));
		  query.setParameter("outtype_s", outtype_s);
