 ...
 */
public class MaterialStoragePlanDataScanExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MaterialStoragePlanDataScanServiceImpl service = (MaterialStoragePlanDataScanServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MaterialStoragePlanDataScanServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MaterialStoragePlanDataScanServiceImpl"));
