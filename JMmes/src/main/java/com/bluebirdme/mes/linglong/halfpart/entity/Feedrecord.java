...
public class Feedrecord extends RockWellBaseEntity{
    ...
    public String getFeedamount_s(){
        return feedamount_s;
    }
    
    @XmlElement
    public void setFeedamount_s(String feedamount_s){
        this.feedamount_s=feedamount_s;
    }
