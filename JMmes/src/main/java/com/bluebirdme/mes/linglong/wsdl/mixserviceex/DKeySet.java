...
/**
 * <p>
 * Java class for DKeySet complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="DKeySet">
 *   &lt;complexContent>
 *     &lt;extension base="{dataobjects.common.plantops.datasweep.com}DDataObject">
 *       &lt;sequence>
 *         &lt;element name="itemKeys" type="{dataobjects.common.plantops.datasweep.com}DLongArray" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "DKeySet", propOrder = { "itemKeys", "keySetItemArrays",
		"objectKey" })
public class DKeySet extends DDataObject {

	@XmlElement(nillable = true)
	protected List<DLongArray> itemKeys;
	@XmlElement(nillable = true)
	 ...
	 * <CODE>set</CODE> method for the itemKeys property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getItemKeys().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<DLongArray> getItemKeys() {
		if (itemKeys == null) {
			itemKeys = new ArrayList<DLongArray>();
		}
