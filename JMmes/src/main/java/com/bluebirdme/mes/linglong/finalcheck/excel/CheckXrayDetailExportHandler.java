 ...
 */
public class CheckXrayDetailExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	CheckXrayDetailServiceImpl service = (CheckXrayDetailServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"CheckXrayDetailServiceImpl"首字母改为小写
   				.firstCharToLowerCase("CheckXrayDetailServiceImpl"));
    ...
    public void regFormatter() {
       ...
       /* // 机构编号：招远 8000；德州 8002  柳州 8003 泰国 8004 荆门 8023
        ...
        // 检查次数
        regFormatter("checkseq_i", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //checkseq_i
        ...
        // 缺陷ID
        regFormatter("defectid_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //defectid_s
        ...
        // 上下模
        regFormatter("upordown_s", new IExcelValueFormatter() {
            @Override
            public String format(Object value) {
                //return sdf.format(new Date((Long)value));
                //upordown_s
