 ...
 */
public class MixStoragePlanResultExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixStoragePlanResultServiceImpl service = (MixStoragePlanResultServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixStoragePlanResultServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixStoragePlanResultServiceImpl"));
