...
import com.bluebirdme.mes.linglong.curing.service.AbnormalServiceImpl;
 ...
 */
@Log(code = "Abnormal", value = "硫化异常固化")
@RestController
@RequestMapping("curing/ProductionManagement/abnormal")
public class AbnormalController extends RockWellFunctionalUDAController<Object> {

    @Resource
    AbnormalServiceImpl abnormalSrv;
    ...
    public String searchReplenishData(Filter filter, Page page) throws Exception {
        ...
        Map list = abnormalSrv.searchReplenishData(filter, page);
        return toJson(list);
    }

    /**
     * 对应硫化与SAP集成报产第七个按钮，异常固化，固化
     *
    ...
    public Response saveChanges(@RequestBody Map<String, Object> rockWellEntityDTO) throws Exception {
        String message=abnormalSrv.guhua(rockWellEntityDTO);
        return Response.error(Response.SYS_EXCEPTION,message,null);
    }

    /**
     * 对应硫化与SAP集成报产第七个按钮，异常固化，明细
     * @param beginTime
     * @param endTime
     * @param lineCode
     * @return
     * @throws Exception
     */
    @Log(code="AT_C_MM_SAPRETURNRESULT_LOG_DETAIL",value="硫化异常明细查询",target=LogType.DB)
    ...
    public String productionDetail(@RequestBody Map<String,Object> workOrderResultReportDTO) throws Exception {
        List<Map<String,Object>> list=abnormalSrv.productionDetail(workOrderResultReportDTO);
        return toJson(list);
    }
    /**
     * 报工单号
    ...
    public String getWorkOrderCode(String q, String type) {
        ...
        List<Object> codes = abnormalSrv.getWorkOrderCode(q, type);
    ...
    public Response guhuaData(String beginTime, String endTime, String material_code_s) throws Exception {
        return Response.suc(abnormalSrv.guhuaData(beginTime, endTime, material_code_s));
    }
}
