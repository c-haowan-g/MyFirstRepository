 ...
 */
public class MixStoragePlanDataProdExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixStoragePlanDataProdServiceImpl service = (MixStoragePlanDataProdServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixStoragePlanDataProdServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixStoragePlanDataProdServiceImpl"));
