...
/**
 * <p>
 * Java class for DLabelDataDefinition complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="DLabelDataDefinition">
 *   &lt;complexContent>
 ...
 *         &lt;element name="DLabelVariables" type="{dataobjects.common.plantops.datasweep.com}DLabelVariable" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "DLabelDataDefinition", propOrder = { "accessControlInfo",
		"dLabelVariables", "deletePrivilegeKey", "updatePrivilegeKey",
		"userDefinedAttributes" })
public class DLabelDataDefinition extends DCategorical {

	protected DAccessControlInfo accessControlInfo;
	@XmlElement(name = "DLabelVariables", nillable = true)
	protected List<DLabelVariable> dLabelVariables;
	...
	/**
	 * Gets the value of the dLabelVariables property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the dLabelVariables property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getDLabelVariables().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<DLabelVariable> getDLabelVariables() {
		if (dLabelVariables == null) {
			dLabelVariables = new ArrayList<DLabelVariable>();
		}
		return this.dLabelVariables;
	}
