 ...
 */
public class CalibRationRecordExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	CalibRationRecordServiceImpl service = (CalibRationRecordServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"CalibRationRecordServiceImpl"首字母改为小写
   				.firstCharToLowerCase("calibRationRecordServiceImpl"));
