...
/**
 * <p>
 * Java class for DArea complex type.
 * 
 * <p>
 ...
 *         &lt;element name="storageZoneKeys" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "DArea", propOrder = { "areaKeys", "connections",
		"currentStates", "deletePrivilegeKey", "graphInfos",
		"graphInfosChanged", "locationKey", "ports", "productionLineKeys",
		"storageZoneKeys", "timeZone", "updatePrivilegeKey",
		"userDefinedAttributes", "workInstructionKeys",
		"workInstructionKeysChanged", "workInstructionListKey",
		"workScheduleKey" })
public class DArea extends DCategorical {
	...
	@XmlElement(type = Long.class)
	protected List<Long> storageZoneKeys;
	...
	/**
	 * Gets the value of the storageZoneKeys property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the storageZoneKeys property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getStorageZoneKeys().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<Long> getStorageZoneKeys() {
		if (storageZoneKeys == null) {
			storageZoneKeys = new ArrayList<Long>();
		}
		return this.storageZoneKeys;
	}
