 ...
 * 质检入库分拣履历表
 * @author lnk
 * @Date 2019-01-04 16:19:05
 */
@ATDefinition("D_QM_SORTSTORAGELOG")
@Entity
@XmlRootElement
@Table(name="AT_D_QM_SORTSTORAGELOG")
public class SortStorageLogs extends RockWellBaseEntity{
    ...
    @Comment("轮胎条码轮胎条码：MES_MainTyre 表 BARCODE")
