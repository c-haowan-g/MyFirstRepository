 ...
 */
public class MaterialStoragePlanDataProdExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MaterialStoragePlanDataProdServiceImpl service = (MaterialStoragePlanDataProdServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MaterialStoragePlanDataProdServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MaterialStoragePlanDataProdServiceImpl"));
