 ...
 */
public class PlmMixWeightExecExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixWeightExecServiceImpl service = (PlmMixWeightExecServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixWeightExecServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixWeightExecServiceImpl"));
