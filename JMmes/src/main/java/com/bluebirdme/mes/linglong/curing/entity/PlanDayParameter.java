 ...
 * 
 * @author 刘朋
 * @Date 2018-09-05 08:33:08
 */
@ATDefinition("_C_PP_PRODUCTIONDAYPLAN")
@Entity
@XmlRootElement
@Table(name = "AT_C_PP_PRODUCTIONDAYPLAN")
public class PlanDayParameter extends RockWellBaseEntity {
	...
	@Comment("左工单号")
	@Column(nullable = true, length = 80)
	private String left_order_number_s;
	...
	@Comment("右月计划数量")
	@Column(nullable = true, length = 0)
	private Integer qty_monthplan_left_i;

	@Comment("右月计划数量")
	@Column(nullable = true, length = 0)
	private Integer qty_monthplan_right_i;
	...
	@Comment("右工单号")
	@Column(nullable = true, length = 80)
	private String right_order_number_s;
	...
	@Comment("无注释")
	@Column(nullable = true, length = 0)
	private Integer stocks_left_i;

	@Comment("无注释")
	@Column(nullable = true, length = 0)
	private Integer stocks_right_i;
	...
	public String getLeft_order_number_s() {
		return left_order_number_s;
	}

	@XmlElement
	public void setLeft_order_number_s(String left_order_number_s) {
		this.left_order_number_s = left_order_number_s;
	}
	...
	public Integer getQty_monthplan_left_i() {
		return qty_monthplan_left_i;
	}

	@XmlElement
	public void setQty_monthplan_left_i(Integer qty_monthplan_left_i) {
		this.qty_monthplan_left_i = qty_monthplan_left_i;
	}

	public Integer getQty_monthplan_right_i() {
		return qty_monthplan_right_i;
	}

	@XmlElement
	public void setQty_monthplan_right_i(Integer qty_monthplan_right_i) {
		this.qty_monthplan_right_i = qty_monthplan_right_i;
	}
	...
	public String getRight_order_number_s() {
		return right_order_number_s;
	}

	@XmlElement
	public void setRight_order_number_s(String right_order_number_s) {
		this.right_order_number_s = right_order_number_s;
	}
	...
	public Integer getStocks_left_i() {
		return stocks_left_i;
	}

	@XmlElement
	public void setStocks_left_i(Integer stocks_left_i) {
		this.stocks_left_i = stocks_left_i;
	}

	public Integer getStocks_right_i() {
		return stocks_right_i;
	}

	@XmlElement
	public void setStocks_right_i(Integer stocks_right_i) {
		this.stocks_right_i = stocks_right_i;
	}
