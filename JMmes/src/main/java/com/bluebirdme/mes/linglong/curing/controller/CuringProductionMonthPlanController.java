 ...
 * @author penga_liu
 * 
 * @Date 2019年7月26日 上午11:24:59
 */
@Log(code = "LH_SCJH_YJH", value = "硫化月计划编制（加工单）日志")
@RestController
@RequestMapping("curing/productionPlan/monthPlan")
public class CuringProductionMonthPlanController extends RockWellFunctionalController<CuringProductionMonthPlan> {

	@Resource
	CuringProductionMonthPlanServiceImpl sapMonthlyPlan;
	@Resource
	...
	@Override
	protected RockWellBaseServiceImpl<CuringProductionMonthPlan> getService() {
		return sapMonthlyPlan;
	}

	@Log(code = "LH_SCJH_YJH_SAVE_CHANGES", value = "硫化月计划保存数据的增删改")
	@RequestMapping("saveChanges")
	public Response saveChanges(@RequestBody CuringProductionMonthPlanDTO sapproductionplan) throws Exception {
		sapMonthlyPlan.saveChanges(sapproductionplan);
		return Response.suc();
	}
