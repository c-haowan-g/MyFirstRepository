...
/**
 * <p>
 * Java class for DLibrary complex type.
 * 
 * <p>
...
@XmlType(name = "DLibrary", propOrder = { "accessControlInfo", "author",
		"blobData", "deletePrivilegeKey", "type", "updatePrivilegeKey" })
public class DLibrary extends DCategorical {
