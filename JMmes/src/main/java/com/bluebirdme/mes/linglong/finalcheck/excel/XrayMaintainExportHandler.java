 ...
 */
public class XrayMaintainExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	XrayMaintainServiceImpl service = (XrayMaintainServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"XrayMaintainServiceImpl"首字母改为小写
   				.firstCharToLowerCase("XrayMaintainServiceImpl"));
