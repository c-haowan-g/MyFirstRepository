 ...
 */
public class MaterialStoragePlanJobExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MaterialStoragePlanJobServiceImpl service = (MaterialStoragePlanJobServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MaterialStoragePlanJobServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MaterialStoragePlanJobServiceImpl"));
