 ...
 */
public class PlmMixRecipeExecHisExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixRecipeExecHisServiceImpl service = (PlmMixRecipeExecHisServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixMrecipeExecHisServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixMrecipeExecHisServiceImpl"));
