 ...
 */
public class WorkOrderEditExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	WorkOrderEditServiceImpl service = (WorkOrderEditServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"WorkOrderEditServiceImpl"首字母改为小写
   				.firstCharToLowerCase("WorkOrderEditServiceImpl"));
    ...
    public void regFormatter() {
        ...
        // 备用字段1：密炼接口预留，产出下发：配方名称，产出回传：修改人姓名
        ...
        // 备用字段2：密炼接口预留，产出下发：架子数，产出回传：修改时间
        ...
        // 备用字段3：密炼接口预留，产出下发：设定重量，产出回传：当前称量车次
