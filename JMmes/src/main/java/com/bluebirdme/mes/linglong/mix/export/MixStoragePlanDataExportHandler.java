 ...
 */
public class MixStoragePlanDataExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixStoragePlanDataServiceImpl service = (MixStoragePlanDataServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixStoragePlanDataServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixStoragePlanDataServiceImpl"));
