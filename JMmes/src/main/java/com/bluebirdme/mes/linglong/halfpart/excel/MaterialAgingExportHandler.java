 ...
 */
public class MaterialAgingExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MaterialAgingServiceImpl service = (MaterialAgingServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MaterialsPlusServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MaterialsPlusServiceImpl"));
