...
@RestController
@RequestMapping("finalcheck/reportCenter/DynaBalanceTestReport")
public class DynaBalanceTestReportController extends RockWellFunctionalUDAController<Object> {

	@Resource
	DynaBalanceTestReportServiceImpl dynaBalanceTestReportService;

	@Override
	protected RockWellBaseServiceImpl<Object> getService() {
		return dynaBalanceTestReportService;
	}
	...
	public String filter(Filter filter, Page page)
			throws Exception {
        Map<String,Object> map = dynaBalanceTestReportService.filter(filter, page);
		return toJson(map);
	}
	...
	public String searchBy(String begin_created_time,String end_created_time,String curingspeccode_s) throws Exception{
		...
		List<Map<String, Object>> list = dynaBalanceTestReportService.datagridRowsUDA(filter);
		return toJson(list);
	}
