 ...
 */
public class MixSmallMaterialExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	MixSmallMaterialServiceImpl service = (MixSmallMaterialServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MixSmallMaterialServiceImpl"首字母改为小写
   				.firstCharToLowerCase("MixSmallMaterialServiceImpl"));
