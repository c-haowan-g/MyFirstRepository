 ...
 * /**
 * @author 王超
 * @Date 2020-05-12 08:25:19
 */
@ATDefinition("A_MM_WORKERLOGIN_RECORD")
@Entity
@XmlRootElement
@Table(name="AT_A_MM_WORKERLOGIN_RECORD")
public class WorkerLoginRecord extends RockWellBaseEntity{
    ...
    @Comment("登录类型(0 注销  1登录)")
    @Column(nullable=true,length=80)
    private String login_type_s;
    ...
    public String getClassid_s(){
        return classid_s;
    }
    
    @XmlElement
    public void setClassid_s(String classid_s){
        this.classid_s=classid_s;
    }
    ...
    public String getLogin_type_s(){
        return login_type_s;
    }
    
    @XmlElement
    public void setLogin_type_s(String login_type_s){
        this.login_type_s=login_type_s;
    }
    ...
    public String getWorker_type_s(){
        return worker_type_s;
    }
    
    @XmlElement
    public void setWorker_type_s(String worker_type_s){
        this.worker_type_s=worker_type_s;
    }
