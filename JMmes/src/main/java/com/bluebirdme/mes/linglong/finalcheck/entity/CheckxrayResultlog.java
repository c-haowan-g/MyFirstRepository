 ...
 */
@ATDefinition("D_QM_CHECKXRAYRESULTLOG")
@Entity
@XmlRootElement
@Table(name="AT_D_QM_CHECKXRAYRESULTLOG")
public class CheckxrayResultlog extends RockWellBaseEntity{
    ...
    public String getLogmeg_s(){
        return logmeg_s;
    }
    
    @XmlElement
    public void setLogmeg_s(String logmeg_s){
        this.logmeg_s=logmeg_s;
    }
