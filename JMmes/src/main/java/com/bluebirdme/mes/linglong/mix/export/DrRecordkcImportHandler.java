 ...
 */
public class DrRecordkcImportHandler extends ExcelImportHandler {
    ...
    public void toDB(ExcelContent content) throws Exception {
        List<DrRecordkc> list=convertToEntityList(DrRecordkc.class, content, null);
        DrRecordkcServiceImpl drrecordkcSrv=(DrRecordkcServiceImpl)SpringContext.getBean("drrecordkcServiceImpl");
        drrecordkcSrv.save(list);
    }
