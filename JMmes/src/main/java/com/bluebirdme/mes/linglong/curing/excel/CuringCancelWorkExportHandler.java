 ...
 */
public class CuringCancelWorkExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	CuringCancelWorkServiceImpl service = (CuringCancelWorkServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"CuringCancelWorkServiceImpl"首字母改为小写
   				.firstCharToLowerCase("curingCancelWorkServiceImpl"));
