...
/**
 * <p>
 * Java class for DLocation complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="DLocation">
 *   &lt;complexContent>
 *     &lt;extension base="{dataobjects.common.plantops.datasweep.com}DCategorical">
 *       &lt;sequence>
 *         &lt;element name="childLocationKeys" type="{http://www.w3.org/2001/XMLSchema}long" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="parentLocationKey" type="{http://www.w3.org/2001/XMLSchema}long"/>
...
@XmlType(name = "DLocation", propOrder = { "childLocationKeys",
		"currentStates", "deletePrivilegeKey", "parentLocationKey",
		"updatePrivilegeKey", "userDefinedAttributes" })
public class DLocation extends DCategorical {

	@XmlElement(type = Long.class)
	protected List<Long> childLocationKeys;
	@XmlElement(nillable = true)
	protected List<DObjectState> currentStates;
	protected long deletePrivilegeKey;
	protected long parentLocationKey;
	protected long updatePrivilegeKey;
	protected DUDAInstance userDefinedAttributes;

	/**
	 * Gets the value of the childLocationKeys property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the childLocationKeys property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getChildLocationKeys().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 ...
	 * 
	 */
	public List<Long> getChildLocationKeys() {
		if (childLocationKeys == null) {
			childLocationKeys = new ArrayList<Long>();
		}
		return this.childLocationKeys;
	}
	...
	/**
	 * Gets the value of the parentLocationKey property.
	 * 
	 */
	public long getParentLocationKey() {
		return parentLocationKey;
	}

	/**
	 * Sets the value of the parentLocationKey property.
	 * 
	 */
	public void setParentLocationKey(long value) {
		this.parentLocationKey = value;
	}
