 ...
 */
@ATDefinition("D_BS_PROCESSGRADE_LOG")
@Entity
@XmlRootElement
@Table(name="AT_D_BS_PROCESSGRADE_LOG")
public class ProcessGradeLog extends RockWellBaseEntity{
    ...
    public Integer getGradecode_i(){
        return gradecode_i;
    }
    
    @XmlElement
    public void setGradecode_i(Integer gradecode_i){
    ...
    public Integer getSort_i(){
        return sort_i;
    }
    
    @XmlElement
    public void setSort_i(Integer sort_i){
        this.sort_i=sort_i;
    }
