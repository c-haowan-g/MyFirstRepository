 ...
 */
public class PlmMixMixExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixMixServiceImpl service = (PlmMixMixServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixMixServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixMixServiceImpl"));
