 ...
 */
@ATDefinition("INT_SAP_MATERIALS_EXEC_HIS")
@Entity
@XmlRootElement
@Table(name="AT_INT_SAP_MATERIALS_EXEC_HIS")
public class MaterialsExec extends RockWellBaseEntity{
    ...
    @Comment("工厂特定的物料状态：01-因采购/仓库二被冻结、02-因任务清单/BOM而被冻结、Z1-冻结物料，只能库存收发货、Z2-冻结物料，不允许所有、作、Z3-冻结物料，只能库存收发货和采购")
    @Column(nullable=true,length=80)
    ...
    @Comment("跨工厂物料状态：01-因采购/仓库二被冻结、02-因任务清单/BOM而被冻结、Z1-冻结物料，只能库存收发货、Z2-冻结物料，不允许所有、作、Z3-冻结物料，只能库存收发货和采购")
    @Column(nullable=true,length=80)
