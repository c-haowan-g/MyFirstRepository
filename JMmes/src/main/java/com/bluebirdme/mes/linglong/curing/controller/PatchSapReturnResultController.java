...
import com.bluebirdme.mes.linglong.curing.service.PatchSapReturnResultServiceImpl;

/**
 * 硫化冲产表
 *
 * @author 孙尊龙
 * @Date 2020-05-22 14:31:11
 */
@Log(code = "AT_C_MM_SAPRETURNRESULT_LOG", value = "硫化冲产表")
@RestController
@RequestMapping("curing/ProductionManagement/patch_sap_return_result")
public class PatchSapReturnResultController extends RockWellFunctionalUDAController<Object> {

    @Resource
    PatchSapReturnResultServiceImpl patchsapreturnresultSrv;
    ...
    protected RockWellBaseServiceImpl<Object> getService() {
        return patchsapreturnresultSrv;
    }
    ...
    public String searchReplenishData(Filter filter, Page page) throws Exception {
        ...
        Map list = patchsapreturnresultSrv.searchReplenishData(filter, page);
        return toJson(list);
    }
    ...
    public Response saveChanges(@RequestBody Map<String, Object> rockWellEntityDTO) throws Exception {
        String message=patchsapreturnresultSrv.guhua(rockWellEntityDTO);
    ...
    public String productionDetail(@RequestBody Map<String,Object> workOrderResultReportDTO) throws Exception {
        List<Map<String,Object>> list=patchsapreturnresultSrv.productionDetail(workOrderResultReportDTO);
        return toJson(list);
    }
    /**
     * 报工单号
    ...
    public String getWorkOrderCode(String q, String type) {
        ...
        List<Object> codes = patchsapreturnresultSrv.getWorkOrderCode(q, type);
    ...
    public Response guhuaData(String beginTime, String endTime, String material_code_s) throws Exception {
        return Response.suc(patchsapreturnresultSrv.guhuaData(beginTime, endTime, material_code_s));
    }
}
