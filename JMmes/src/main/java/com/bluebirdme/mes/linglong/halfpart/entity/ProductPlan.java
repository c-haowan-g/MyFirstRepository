...
public class ProductPlan extends RockWellBaseEntity{
    ...
    @Comment("计量单位")
    @Column(nullable=true,length=80)
    private String compangy_s;
    
    @Comment("复制标记")
    @Column(nullable=true,length=80)
    private String copytip_s;
    ...
    public String getCompangy_s(){
        return compangy_s;
    }
    
    @XmlElement
    public void setCompangy_s(String compangy_s){
        this.compangy_s=compangy_s;
    }
        
    public String getCopytip_s(){
        return copytip_s;
    }
    
    @XmlElement
    public void setCopytip_s(String copytip_s){
        this.copytip_s=copytip_s;
    }
