...
public class Machinestate extends RockWellBaseEntity{
    ...
    @Comment("卷曲工 副手")
    @Column(nullable=true,length=80)
    private String curlyworkerassistantone_s;
    
    @Comment("卷曲工 副手")
    @Column(nullable=true,length=80)
    private String curlyworkerassistthree_s;
    
    @Comment("卷曲工 副手")
    @Column(nullable=true,length=80)
    private String curlyworkerassisttwo_s;
    ...
    @Comment("入库标识")
    @Column(nullable=true,length=80)
    private String inwarehouseflag_s;
    ...
    @Comment("产出打印数量")
    @Column(nullable=true,length=80)
    private String printquantity_s;
    ...
    public String getClothliner_s(){
        return clothliner_s;
    }
    
    @XmlElement
    public void setClothliner_s(String clothliner_s){
        this.clothliner_s=clothliner_s;
    }
    ...
    public String getCurlyworkerassistantone_s(){
        return curlyworkerassistantone_s;
    }
    
    @XmlElement
    public void setCurlyworkerassistantone_s(String curlyworkerassistantone_s){
        this.curlyworkerassistantone_s=curlyworkerassistantone_s;
    }
        
    public String getCurlyworkerassistthree_s(){
        return curlyworkerassistthree_s;
    }
    
    @XmlElement
    public void setCurlyworkerassistthree_s(String curlyworkerassistthree_s){
        this.curlyworkerassistthree_s=curlyworkerassistthree_s;
    }
        
    public String getCurlyworkerassisttwo_s(){
        return curlyworkerassisttwo_s;
    }
    
    @XmlElement
    public void setCurlyworkerassisttwo_s(String curlyworkerassisttwo_s){
        this.curlyworkerassisttwo_s=curlyworkerassisttwo_s;
    }
    ...
    public String getColumn_4_s(){
        return column_4_s;
    }
    
    @XmlElement
    public void setColumn_4_s(String column_4_s){
        this.column_4_s=column_4_s;
    }
    ...
    public String getInwarehouseflag_s(){
        return inwarehouseflag_s;
    }
    
    @XmlElement
    public void setInwarehouseflag_s(String inwarehouseflag_s){
        this.inwarehouseflag_s=inwarehouseflag_s;
    }
    ...
    public String getPrintquantity_s(){
        return printquantity_s;
    }
    
    @XmlElement
    public void setPrintquantity_s(String printquantity_s){
        this.printquantity_s=printquantity_s;
    }
