 ...
 */
@ATDefinition("RM_WH_ITEM_INV_RECORD")
@Entity
@XmlRootElement
@Table(name="AT_RM_WH_ITEM_INV_RECORD")
public class WhItemInvRecord extends RockWellBaseEntity{
    ...
    @Comment("库存操作时间")
    @Column(nullable=true,length=0)
    private Date enter_time_t;
    
    @Comment("主键ID")
    @Column(nullable=true,length=80)
    private String id_s;
    
    @Comment("库存操作类型：008001-入库、008002-出库、008003-移库、008004-发料、008005-第三方反馈、008006-盘库")
    @Column(nullable=true,length=80)
    ...
    @Comment("库存操作区分： 004001-采购新增入临时库 004002-采购新增入正式库 004003-手动入库 004004-退库入库 004010-生产出库 004011-手动出库 004012-检查出库 004013-不良出库  004020-生产移库 004021-手动移库 004022-检查移库 004023-不良移库 004024-手动盘库 004030-手动发料 004031-自动发料 004040-库存更新 004041-其它")
    @Column(nullable=true,length=25)
    ...
    public Date getEnter_time_t(){
        return enter_time_t;
    }
    
    @XmlElement
    public void setEnter_time_t(Date enter_time_t){
        this.enter_time_t=enter_time_t;
    }
    ...
    public String getTray_qty_s(){
        return tray_qty_s;
    }
    
    @XmlElement
    public void setTray_qty_s(String tray_qty_s){
        this.tray_qty_s=tray_qty_s;
    }
