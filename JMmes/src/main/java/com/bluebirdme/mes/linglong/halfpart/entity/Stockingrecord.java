 ...
 */
@ATDefinition("A_SM_STOCKINGRECORD")
@Entity
@XmlRootElement
@Table(name="AT_A_SM_STOCKINGRECORD")
public class Stockingrecord extends RockWellBaseEntity{
    ...
    @Comment("盘库信息来源  0：立库 1：人工 2:MES  ")
    @Column(nullable=true,length=80)
    ...
    public Integer getQuantity_i(){
        return quantity_i;
    }
    
    @XmlElement
    public void setQuantity_i(Integer quantity_i){
        this.quantity_i=quantity_i;
    }
