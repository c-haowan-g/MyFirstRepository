 ...
 */
public class MixStoragePlanDataImportHandler extends ExcelImportHandler {
    ...
    public void toDB(ExcelContent content) throws Exception {
        List<MixStoragePlanData> list=convertToEntityList(MixStoragePlanData.class, content, null);
        MixStoragePlanDataServiceImpl mixstorageplandataSrv=(MixStoragePlanDataServiceImpl)SpringContext.getBean("mixstorageplandataServiceImpl");
        mixstorageplandataSrv.save(list);
    }
