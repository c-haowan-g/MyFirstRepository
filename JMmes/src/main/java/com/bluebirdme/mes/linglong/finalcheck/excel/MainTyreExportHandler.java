 ...
 */
public class MainTyreExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	QualityInformationServiceImpl service = (QualityInformationServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"MainTyreServiceImpl"首字母改为小写
   				.firstCharToLowerCase("QualityInformationServiceImpl"));
