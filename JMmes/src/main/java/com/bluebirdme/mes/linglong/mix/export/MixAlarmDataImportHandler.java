 ...
 */
public class MixAlarmDataImportHandler extends ExcelImportHandler {
    ...
    public void toDB(ExcelContent content) throws Exception {
        List<MixAlarmData> list=convertToEntityList(MixAlarmData.class, content, null);
        MixAlarmDataServiceImpl mixalarmdataSrv=(MixAlarmDataServiceImpl)SpringContext.getBean("mixalarmdataServiceImpl");
        mixalarmdataSrv.save(list);
    }
