 ...
 */
@ATDefinition("B_MM_STORAGEAREA_RECORD")
@Entity
@XmlRootElement
@Table(name="AT_B_MM_STORAGEAREA_RECORD")
public class StorageAreaRecord extends RockWellBaseEntity{
    ...
    @Comment("操作方式 数据字典362")
    @Column(nullable=true,length=80)
    private String operattype_s;
    ...
    public String getOperattype_s(){
        return operattype_s;
    }
    
    @XmlElement
    public void setOperattype_s(String operattype_s){
        this.operattype_s=operattype_s;
    }
