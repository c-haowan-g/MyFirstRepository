 ...
 */
public class ReturnPolyRecordExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	ReturnPolyRecordServiceImpl service = (ReturnPolyRecordServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"ReturnPolyRecordServiceImpl"首字母改为小写
   				.firstCharToLowerCase("ReturnPolyRecordServiceImpl"));
