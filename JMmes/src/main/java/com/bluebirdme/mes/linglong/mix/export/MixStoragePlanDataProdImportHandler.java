 ...
 */
public class MixStoragePlanDataProdImportHandler extends ExcelImportHandler {
    ...
    public void toDB(ExcelContent content) throws Exception {
        List<MixStoragePlanDataProd> list=convertToEntityList(MixStoragePlanDataProd.class, content, null);
        MixStoragePlanDataProdServiceImpl mixstorageplandataprodSrv=(MixStoragePlanDataProdServiceImpl)SpringContext.getBean("mixstorageplandataprodServiceImpl");
        mixstorageplandataprodSrv.save(list);
    }
