...
import com.bluebirdme.mes.linglong.finalcheck.service.DynaBalanceCheResultPrintBGServiceImpl;
...
@RestController
@RequestMapping("finalcheck/qualityInspectionRecord/dynaBalanceCheResultPrintBG")
public class DynaBalanceCheResultPrintBGController extends RockWellFunctionalUDAController<Object> {

	@Resource
	DynaBalanceCheResultPrintBGServiceImpl dynaBalanceCheResultPrintService;
	...
	//数据导出
  	...
  	public void exprot(@RequestParam("sumFlag")String[] sumFlag,@RequestParam("starttime")String starttime,@RequestParam("endtime")String endtime,@RequestParam("curingspeccode")String curingspeccode) throws Exception{
		...
		if(queryList.contains("curingmachinecode_s")&&sumFlag.length==1){
			title="硫化机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(queryList.contains("buildinmachinecode_s")&&sumFlag.length==1){
			title="成型机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(queryList.contains("dynaBalancemachinecode_s")&&sumFlag.length==1){
			title="动平衡机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(queryList.contains("buildinmachinecode_s")&&queryList.contains("curingmachinecode_s")&&sumFlag.length==2){
			title="成型机台,硫化机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(queryList.contains("buildinmachinecode_s")&&queryList.contains("dynaBalancemachinecode_s")&&sumFlag.length==2){
			title="成型机台,动平衡机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(queryList.contains("curingmachinecode_s")&&queryList.contains("dynaBalancemachinecode_s")&&sumFlag.length==2){
			title="硫化机台,动平衡机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
		if(sumFlag.length==3){
			title="成型机台,硫化机台,动平衡机台,物料编码,物料描述,受检总数,动平衡A+1,动平衡A+1品率,跳动度A+1,跳动度A+1品率,均匀性A+1,均匀性A+1品率,A+1,A+1品率,动平衡A,动平衡A品率,跳动度A,跳动度A品率,均匀性A,均匀性A品率,A,A品率,动平衡A0,动平衡A0品率,跳动度A0,跳动度A0品率,均匀性A0,均匀性A0品率,A0,A0品率,动平衡D,动平衡D品率,跳动度D,跳动度D品率,均匀性D,均匀性D品率,二级,二级品率";
		}
