 ...
 */
public class PlmMixMixExecHisExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	PlmMixMixExecHisServiceImpl service = (PlmMixMixExecHisServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"PlmMixMixExecHisServiceImpl"首字母改为小写
   				.firstCharToLowerCase("PlmMixMixExecHisServiceImpl"));
