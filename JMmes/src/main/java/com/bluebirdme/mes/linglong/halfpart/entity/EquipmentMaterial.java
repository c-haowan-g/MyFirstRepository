 ...
 */
@ATDefinition("A_EM_EquipmentMaterial")
@Entity
@XmlRootElement
@Table(name="AT_A_EM_EQUIPMENTMATERIAL")
public class EquipmentMaterial extends RockWellBaseEntity{
    ...
    @Comment("是否是主物料 0：主物料 1：副物料")
    @Column(nullable=true,length=80)
    private String isprimary_s;
    ...
    public String getIsprimary_s(){
        return isprimary_s;
    }
    
    @XmlElement
    public void setIsprimary_s(String isprimary_s){
        this.isprimary_s=isprimary_s;
    }
