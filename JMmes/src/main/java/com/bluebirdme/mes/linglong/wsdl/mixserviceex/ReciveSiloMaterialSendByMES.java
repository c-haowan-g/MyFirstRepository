...
@XmlType(name = "", propOrder = { "user", "password", "id", "sendBy",
		"sendName" })
@XmlRootElement(name = "reciveSiloMaterialSendByMES", namespace = "http://tempuri.org/")
public class ReciveSiloMaterialSendByMES {
