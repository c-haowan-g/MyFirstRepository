...
public class Plan extends RockWellBaseEntity{
    ...
    @Column(nullable=true,length=0)
    private String qty_check_mid_f;
    
    @Comment("早班计划检验量：车数*检验百分比")
    @Column(nullable=true,length=0)
    private String qty_check_mor_f;
    
    @Comment("晚班计划检验量：车数*检验百分比")
    @Column(nullable=true,length=0)
    private String qty_check_nig_f;
    
    @Comment("日计划检验量：车数*检验百分比")
    @Column(nullable=true,length=0)
    private String qty_check_plan_f;
    ...
    public String getQty_check_mid_f(){
        return qty_check_mid_f;
    }
    
    @XmlElement
    public void setQty_check_mid_f(String qty_check_mid_f){
        this.qty_check_mid_f=qty_check_mid_f;
    }
        
    public String getQty_check_mor_f(){
        return qty_check_mor_f;
    }
    
    @XmlElement
    public void setQty_check_mor_f(String qty_check_mor_f){
        this.qty_check_mor_f=qty_check_mor_f;
    }
        
    public String getQty_check_nig_f(){
        return qty_check_nig_f;
    }
    
    @XmlElement
    public void setQty_check_nig_f(String qty_check_nig_f){
        this.qty_check_nig_f=qty_check_nig_f;
    }
        
    public String getQty_check_plan_f(){
        return qty_check_plan_f;
    }
    
    @XmlElement
    public void setQty_check_plan_f(String qty_check_plan_f){
