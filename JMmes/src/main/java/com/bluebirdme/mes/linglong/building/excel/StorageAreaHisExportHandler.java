 ...
 */
public class StorageAreaHisExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	StorageAreaHisServiceImpl service = (StorageAreaHisServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"StorageAreaHisServiceImpl"首字母改为小写
   				.firstCharToLowerCase("storageAreaHisServiceImpl"));
