 ...
 */
public class DrprodxlExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	DrprodxlServiceImpl service = (DrprodxlServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"DrprodxlServiceImpl"首字母改为小写
   				.firstCharToLowerCase("DrprodxlServiceImpl"));
