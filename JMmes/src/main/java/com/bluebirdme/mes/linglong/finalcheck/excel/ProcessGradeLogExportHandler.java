 ...
 */
public class ProcessGradeLogExportHandler extends DefaultExcelExportHandler {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked", "null" })
   	...
   	public List<Object> getRows(Filter filter, Page page, String serviceName)
   			throws Exception {
    	ProcessGradeLogServiceImpl service = (ProcessGradeLogServiceImpl) SpringContext
   				.getBean(StringUtils
   						.firstCharToLowerCase("processGradeLogServiceImpl"));
   		...
   		List<ProcessGradeLog> entityList = service.datagridRows(filter, page,
   				ProcessGradeLog.class);
   		/*// 转换下拉框
