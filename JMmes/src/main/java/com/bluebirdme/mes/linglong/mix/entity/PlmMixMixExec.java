 ...
 */
@ATDefinition("INT_PLM_MIXMIX_EXEC")
@Entity
@XmlRootElement
@Table(name="AT_INT_PLM_MIXMIX_EXEC")
public class PlmMixMixExec extends RockWellBaseEntity{
    ...
    @Column(nullable=true,length=80)
    private String recipe_source_type_s;
    ...
    public String getRecipe_source_type_s(){
        return recipe_source_type_s;
    }
    
    @XmlElement
    public void setRecipe_source_type_s(String recipe_source_type_s){
        this.recipe_source_type_s=recipe_source_type_s;
    }
