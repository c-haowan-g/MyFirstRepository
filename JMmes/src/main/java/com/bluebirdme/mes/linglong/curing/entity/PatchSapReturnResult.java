 ...
 */
@ATDefinition("C_MM_SAPRETURNRESULT")
@Entity
@XmlRootElement
@Table(name="AT_C_MM_SAPRETURNRESULT")
public class PatchSapReturnResult extends RockWellBaseEntity{
    ...
    @Comment("是否条码替换：0否,1是")
    @Column(nullable=true,length=80)
    private String spare2_s;

    @Comment("是否规格更正：0否，1是")
    @Column(nullable=true,length=80)
    ...
    public String getChaged_by_s(){
        return chaged_by_s;
    }

    @XmlElement
    public void setChaged_by_s(String chaged_by_s){
        this.chaged_by_s=chaged_by_s;
    }
