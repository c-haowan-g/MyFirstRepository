 ...
 */
@ATDefinition("C_MM_CAPSULE")
@Entity
@XmlRootElement
@Table(name="AT_C_MM_CAPSULE")
public class Capsule extends RockWellBaseEntity{
    ...
    public Integer getOnhand_i(){
        return onhand_i;
    }
    
    @XmlElement
    public void setOnhand_i(Integer onhand_i){
        this.onhand_i=onhand_i;
    }
