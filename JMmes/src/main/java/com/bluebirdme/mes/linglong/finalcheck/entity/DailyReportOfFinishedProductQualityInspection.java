 ...
 * 成品质量检查日报表
 * @author syl
 * @Date 2018-12-3 09:40:09
 */
@ATDefinition("C_MM_MAINTYRE")
@Entity
@XmlRootElement
@Table(name="AT_C_MM_MAINTYRE")
public class DailyReportOfFinishedProductQualityInspection extends RockWellBaseEntity{
    ...
    @Comment("物流推送-推送标记：0-未推送，true-已推送")
    @Column(nullable=true,length=80)
    ...
    @Comment("轮胎状态编码：0-待检、true-合格、2-不合格")
    @Column(nullable=true,length=80)
