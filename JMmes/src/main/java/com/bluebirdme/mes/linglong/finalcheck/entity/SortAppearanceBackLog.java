 ...
 */
@ATDefinition("D_QM_SORTAPPEARANCEALOG")
@Entity
@XmlRootElement
@Table(name = "AT_D_QM_SORTAPPEARANCEALOG")
public class SortAppearanceBackLog extends RockWellBaseEntity {
	...
	@Comment("实际去向：D_EM_Ent 表 ENTBARCODE")
	@Column(nullable = true, length = 80)
	...
	@Comment("分拣去向：D_EM_Ent 表 ENTBARCODE")
	@Column(nullable = true, length = 80)
