 ...
 */
@ATDefinition("INT_PLM_HALFPARTRECIPEPARA")
@Entity
@XmlRootElement
@Table(name="AT_INT_PLM_HALFPARTRECIPEPARA")
public class PlmHalfpartRecipePara extends RockWellBaseEntity{
    ...
    @Comment("参数类型： 半成品-半钢：302001-302015 半成品-全钢：301001-301028 半成品-特胎：303001-303014")
    @Column(nullable=true,length=80)
    ...
    @Comment("设备类型名称： 10-挤出联动线 11-钢丝圈成型机 12-胎圈成型机 13-内衬层压延机 14-零度带束层挤出机 15-纤维帘布压延机 16-钢丝脸部压延机 17-多刀裁断机 18-纤维帘布裁断机 19-钢丝帘布裁断机 20-尼龙帘布一次裁断 21-尼龙帘布二次裁断 22-全钢一次发成型机 23-半钢VMI一次发成型机 24-半钢克虏伯一次发成型机 25-半钢二次法成型机")
    @Column(nullable=true,length=80)
    ...
    @Comment("参数类型名称： 101-工艺控制参数 102-施工显示参数 172-施工显示参数 173-显示控制参数 301-工艺控制参数 302-施工显示参数 304-施工控制参数")
    @Column(nullable=true,length=80)
