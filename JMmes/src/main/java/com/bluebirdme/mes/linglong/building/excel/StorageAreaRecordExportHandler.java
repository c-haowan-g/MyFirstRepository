 ...
 */
public class StorageAreaRecordExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	StorageAreaRecordServiceImpl service = (StorageAreaRecordServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"StorageAreaRecordServiceImpl"首字母改为小写
   				.firstCharToLowerCase("StorageAreaRecordServiceImpl"));
