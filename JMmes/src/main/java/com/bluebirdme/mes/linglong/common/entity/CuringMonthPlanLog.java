 ...
 */
@ATDefinition("C_MM_MainTyre_QtyLOG")
@Entity
@XmlRootElement
@Table(name="AT_C_MM_MAINTYRE_QTYLOG")
public class CuringMonthPlanLog extends RockWellBaseEntity{
    ...
    @Comment("产量更新标记：0-未更新，1-已更新")
    @Column(nullable=true,length=80)
    private String spare1_s;
    
    @Comment("过动平衡量跟新标记：0-未更新，1-已更新")
    @Column(nullable=true,length=80)
