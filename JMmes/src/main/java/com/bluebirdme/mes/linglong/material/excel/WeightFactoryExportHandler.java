 ...
 */
public class WeightFactoryExportHandler extends DefaultExcelExportHandler {
    
    SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    
    @Override
   	public List<Object> getRows(Filter filter, Page page, String serviceName) throws Exception {
    	WeightFactoryServiceImpl service = (WeightFactoryServiceImpl) SpringContext.getBean(StringUtils
    		//需要将"WeightFactoryServiceImpl"首字母改为小写
   				.firstCharToLowerCase("WeightFactoryServiceImpl"));
