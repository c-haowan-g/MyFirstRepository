 ...
 */
@ATDefinition("MX_MM_RECIPEWEIGHT_PROD")
@Entity
@XmlRootElement
@Table(name="AT_MX_MM_RECIPEWEIGHT_PROD")
public class MixRecipeWeightProd extends RockWellBaseEntity{
    ...
    @Comment("外键ID：MX_MM_RECIPE_PROD.ID")
    @Column(nullable=true,length=80)
    private String recipeprod_id_s;
    ...
    public String getRecipeprod_id_s(){
        return recipeprod_id_s;
    }
    
    @XmlElement
    public void setRecipeprod_id_s(String recipeprod_id_s){
        this.recipeprod_id_s=recipeprod_id_s;
    }
