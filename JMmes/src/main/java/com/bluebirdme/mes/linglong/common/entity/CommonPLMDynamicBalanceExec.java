 ...
 * PLM动平衡标准执行表
 * @author 刘程明
 * @Date 2019-07-09 09:04:57
 */
@ATDefinition("INT_PLM_DYNAMICBALANCEEXEC")
@Entity
@XmlRootElement
@Table(name="AT_INT_PLM_DYNAMICBALANCEEXEC")
public class CommonPLMDynamicBalanceExec extends RockWellBaseEntity{
    ...
    @Comment("锥度下限2")
    @Column(nullable=true,length=80)
    private String taperlowerboundtwo_s;
    ...
    @Comment("锥度上限2")
    @Column(nullable=true,length=80)
    private String taperupperboundtwo_s;
    ...
    public String getTaperlowerboundtwo_s(){
        return taperlowerboundtwo_s;
    }
    
    @XmlElement
    public void setTaperlowerboundtwo_s(String taperlowerboundtwo_s){
        this.taperlowerboundtwo_s=taperlowerboundtwo_s;
    }
    ...
    public String getTaperupperboundtwo_s(){
        return taperupperboundtwo_s;
    }
    
    @XmlElement
    public void setTaperupperboundtwo_s(String taperupperboundtwo_s){
        this.taperupperboundtwo_s=taperupperboundtwo_s;
    }
