...
public class PatchWorkOrderResultServiceImpl extends RockWellUDABaseServiceImpl<Object> {
    ...
    public List<Map<String, Object>> lhqx(Map<String, Object> map) {
        // 全钢曲线服务
        ...
        if (equip_code_s.substring(3, 4) != null) {
            ...
            if (LLWebUtils.factory().equals("2")) {
                ...
                if (position.equals("L")) {
                    ...
                    nw = "LLJM_SCADA:OPC003:Curing" + jth + ".Curing" + jth + ".Technology.LeftInnerTemperatureView";
                    bx = "LLJM_SCADA:OPC003:Curing" + jth + ".Curing" + jth + ".Technology.LeftStepView";
                    /*
                     * } else{ rbwd="QGSCADA:QGOPC12:Curing"+jth+".Curing"+jth+
                     * ".Technology.LeftHotBoardTemperatureView";
                     * rhwd="QGSCADA:QGOPC12:Curing"
                     * +jth+".Curing"+jth+".Technology.LeftHotRingView";
                     * ny="QGSCADA:QGOPC12:Curing"
                     * +jth+".Curing"+jth+".Technology.LeftInnerPressureView";
                     * nw="QGSCADA:QGOPC12:Curing"+jth+".Curing"+jth+
                     * ".Technology.LeftInnerTemperatureView"; bx =
                     * "QGSCADA:QGOPC12:Curing" + jth + ".Curing" + jth +
                     * ".Technology.LeftStepView"; }
                     */
                } else if (position.equals("R")) {
                    // if(codes.equals("D")||codes.equals("E")||codes.equals("F")||codes.equals("G")){
                    ...
                    nw = "LLJM_SCADA:OPC003:Curing" + jth + ".Curing" + jth + ".Technology.RightInnerTemperatureView";
                    bx = "LLJM_SCADA:OPC003:Curing" + jth + ".Curing" + jth + ".Technology.RightStepView";
                    /*
                     * } else{ rbwd="QGSCADA:QGOPC12:Curing"+jth+".Curing"+jth+
                     * ".Technology.RightHotBoardTemperatureView";
                     * rhwd="QGSCADA:QGOPC12:Curing"
                     * +jth+".Curing"+jth+".Technology.RightHotRingView";
                     * ny="QGSCADA:QGOPC12:Curing"
                     * +jth+".Curing"+jth+".Technology.RightInnerPressureView";
                     * nw="QGSCADA:QGOPC12:Curing"+jth+".Curing"+jth+
                     * ".Technology.RightInnerTemperatureView"; bx =
                     * "QGSCADA:QGOPC12:Curing" + jth + ".Curing" + jth +
                     * ".Technology.RightStepView"; }
                     */
                }
    ...
    public List<Map<String, Object>> dxyl(Map<String, Object> map) {
        ...
        String endtime = listObject1.get(0).toString();
        // 全钢接口
        ...
        if (equip_code_s.substring(3, 4) != null) {
            ...
            if (LLWebUtils.factory().equals("2")) {
                ...
                if (position.equals("L")) {
                    // if(codes.equals("D")||codes.equals("E")||codes.equals("F")||codes.equals("G")){
                    dxyl = "LLJM_SCADA:OPC003:Curing" + jth + ".Curing" + jth + ".Technology.LeftBuildingPressureView";
                    /*
                     * } else { dxyl = "QGSCADA:BGOPC12:Curing" + jth +
                     * ".Curing" + jth + ".Technology.LeftBuildingPressureView";
                     * }
                     */
                } else if (position.equals("R")) {
                    // if(codes.equals("D")||codes.equals("E")||codes.equals("F")||codes.equals("G")){
...
//        Thread.currentThread().sleep(5000);
    ...
    public String curing(Map<String, Object> workOrderResultReportDTO) throws Exception {
        ...
        for (Map<String, Object> item : selectRows) {
            ...
            if (item.get("tyre_barcode_s") != null && item.get("tyre_barcode_s") != "") {
                tyreBarcode = item.get("tyre_barcode_s").toString();
            }
            ...
            if (materialCode != null && classId != null && productionver != null && beginTime != null
                ...
                mesSapProduction.setQuantity_f("1");// 实际数量
                mesSapProduction.setActual_quantity_f("1");// 实际固化数量
    ...
    public List<Map<String, Object>> productionDetailByCuring(Map<String, Object> workOrderResultReportDTO,
        ...
        String tyreBarcode= workOrderResultReportDTO.get("tyre_barcode_s").toString();
        ...
        query.setParameter("tyreBarcode", tyreBarcode);
        List<Map<String, Object>> listMap = query.list();
        // 大写变小写转换后的list
        List<Map<String, Object>> returnlist = new ArrayList<Map<String, Object>>();
        for (Map<String, Object> orgMap : listMap) {
    ...
    public List<Map<String, Object>> productionDetail(Map<String, Object> workOrderResultReportDTO) throws Exception {
        ...
        String tyreBarcode= selectRows.get(0).get("tyre_barcode_s").toString();
