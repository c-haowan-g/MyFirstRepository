 ...
 */
@ATDefinition("A_EM_EQUIPMENTSTOPRECORD")
@Entity
@XmlRootElement
@Table(name="AT_A_EM_EQUIPMENTSTOPRECORD")
public class HalfpartEquipmentStoprecord extends RockWellBaseEntity{
    ...
    @Comment("报警来源 基础数据159 ")
    @Column(nullable=true,length=80)
    private String downtime_source_s;
    
    @Comment("报警处理状态 基础数据160 ")
    @Column(nullable=true,length=80)
    ...
    @Comment("子设备条码 ")
    @Column(nullable=true,length=80)
    private String sub_equip_code_s;
    ...
    public String getSub_equip_code_s(){
        return sub_equip_code_s;
    }
    
    @XmlElement
    public void setSub_equip_code_s(String sub_equip_code_s){
        this.sub_equip_code_s=sub_equip_code_s;
    }
