...
@XmlType(name = "", propOrder = { "user", "password", "planNo", "sendBy",
		"sendName" })
@XmlRootElement(name = "reciveMaterialApplyByMES", namespace = "http://tempuri.org/")
public class ReciveMaterialApplyByMES {
