 ...
 * element interface generated in the lh package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _PIReturnObject_QNAME = new QName(
			"http://schemas.datacontract.org/2004/07/PISdkDemo",
			"PIReturnObject");
	...
	private final static QName _PIReturnObjectRRetmsg_QNAME = new QName(
			"http://schemas.datacontract.org/2004/07/PISdkDemo", "r_retmsg");
	private final static QName _QueryRealDataResponseQueryRealDataResult_QNAME = new QName(
			"http://tempuri.org/", "QueryRealDataResult");
	private final static QName _QueryRealDataMachineid_QNAME = new QName(
			"http://tempuri.org/", "machineid");
	private final static QName _QueryRealDataPoint_QNAME = new QName(
			"http://tempuri.org/", "point");
	private final static QName _QueryRealDataEndtime_QNAME = new QName(
			"http://tempuri.org/", "endtime");
	private final static QName _QueryRealDataFromtime_QNAME = new QName(
			"http://tempuri.org/", "fromtime");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: lh
	 * 
	 */
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link ArrayOfanyType }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<ArrayOfanyType> createArrayOfanyType(ArrayOfanyType value) {
		return new JAXBElement<ArrayOfanyType>(_ArrayOfanyType_QNAME,
				ArrayOfanyType.class, null, value);
	}
	...
	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link PIReturnObject }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<PIReturnObject> createPIReturnObject(PIReturnObject value) {
		return new JAXBElement<PIReturnObject>(_PIReturnObject_QNAME,
				PIReturnObject.class, null, value);
	}
	...
	public JAXBElement<String> createPIReturnObjectRRetmsg(String value) {
		return new JAXBElement<String>(_PIReturnObjectRRetmsg_QNAME,
				String.class, PIReturnObject.class, value);
	}
	...
	public JAXBElement<PIReturnObject> createQueryRealDataResponseQueryRealDataResult(
			PIReturnObject value) {
		return new JAXBElement<PIReturnObject>(
				_QueryRealDataResponseQueryRealDataResult_QNAME,
				PIReturnObject.class, QueryRealDataResponse.class, value);
	}
	...
	public JAXBElement<String> createQueryRealDataMachineid(String value) {
		return new JAXBElement<String>(_QueryRealDataMachineid_QNAME,
				String.class, QueryRealData.class, value);
	}
	...
	public JAXBElement<String> createQueryRealDataPoint(String value) {
		return new JAXBElement<String>(_QueryRealDataPoint_QNAME, String.class,
				QueryRealData.class, value);
	}
	...
	public JAXBElement<String> createQueryRealDataEndtime(String value) {
		return new JAXBElement<String>(_QueryRealDataEndtime_QNAME,
				String.class, QueryRealData.class, value);
	}
	...
	public JAXBElement<String> createQueryRealDataFromtime(String value) {
		return new JAXBElement<String>(_QueryRealDataFromtime_QNAME,
				String.class, QueryRealData.class, value);
	}
