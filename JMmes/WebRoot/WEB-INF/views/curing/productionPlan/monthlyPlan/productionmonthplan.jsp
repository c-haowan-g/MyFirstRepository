<!-- 
    ...
    页面名称:硫化月计划编制（加工单）
    文件关联:
        CuringProductionMonthPlan.java
        CuringProductionMonthPlanController.java
        CuringProductionMonthPlanServiceImpl.java
        CuringProductionMonthPlanServiceImpl.xml
 -->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../../inc/meta.jsp"%>
<%@ include file="productionmonthplan.js.jsp"%>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<div id="SapProductionPlan_dg_toolbar">
			<form id="SapProductionPlan_search_form" class="form">
                ...
                <input name="filter[plan_status_s]" id="plan_status_s" type="text" style="width:130px;" class="easyui-combotree" 
                	data-options="label:'',
                	valueField:'code',
                	textField:'text',
                	url:'dict/code/217'" >
				...
				<input name="filter[material_name_s]" id="material_name_s"
					...
					style="width:130px;">
				<!-- 月计划好 -->
				<spring:message code="sapproductionplan.column.planno_month_s" />:
				<input name="filter[planno_month_s]" id="planno_month_s"
					type="text" class="easyui-textbox"
					data-options="
                	label:''"
					style="width:130px;"> 
					<a class="easyui-linkbutton btn-yellow"
					data-options="iconCls:'icon-search'" onclick="filter()"><spring:message code="button.search" /></a>
			</form>
	...
	<jsp:include page="../../../../inc/import.jsp">
		<jsp:param name="handlerClass"
			value="com.bluebirdme.mes.linglong.curing.excel.SapProductionPlanImportHandler" />
	...
	<jsp:include page="../../../../inc/export.jsp">
		...
		<jsp:param name="handlerClass" value="com.bluebirdme.mes.linglong.curing.excel.SapProductionPlanExportHandler" />
