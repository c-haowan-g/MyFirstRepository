    ...
    <div data-options="region:'center',split:true,border:false" >
        <div id="ProductionDayPlan_dg_toolbar">
            <form id="ProductionDayPlan_search_form">
	            ...
	            <input type="text" name="filter[production_line_s]" id="production_line_s" class="easyui-combobox" data-options="required:true,data:jtxx,panelHeight:150,editable:true,valueField:'P_LINE_NAME',textField:'P_LINE_NAME',selectOnNavigation:false,limitToList:true,filter:searchProductionLine,onChange:filter" />
        ...
        <table id="productiondayplan_dg" class="easyui-datagrid" style="width:100%"
             ...
             <thead data-options="frozen:true">
	            <tr>
                    ...
                    <th data-options="field:'production_date_s',width:70,editor:{type:'textbox',options:{editable:false,required:true,icons:[]}}"><spring:message code="productiondayplan.column.production_date_s" /></th>
                     <!-- 日计划号 -->
                    <th data-options="field:'plan_no_s',width:120,editor:{type:'textbox',options:{editable:false,icons:[],required:true}}"><spring:message code="productiondayplan.column.plan_no_s" /></th>
                    <!-- 产线条码 -->
            ...
            <thead>
                <tr>
                    <!-- 物料编码(左) -->
                    <th data-options="field:'material_code_left_s',width:130,
                    editor:{type:'combobox',
                    options:{icons:[{iconCls:'icon-clear',handler:materialClear_left}],
                    onChange:onMaterialChage_left,
                    delay:300,panelWidth:300,required:true,
                    url:'curing/productionPlan/monthlyPlan/materials',
                    ...
                    limitToList:true,
                    onSelect:onMaterialSelect_left}}"><spring:message code="productiondayplan.column.material_code_left_s" /></th>
                    <!-- 物料编码(右) -->
                    <th data-options="field:'material_code_right_s',width:130,
                    editor:{type:'combobox',
                    options:{icons:[{iconCls:'icon-clear',handler:materialClear_right}],
                    onChange:onMaterialChage_right,delay:300,panelWidth:300,required:true,
                    url:'curing/productionPlan/monthlyPlan/materials',onBeforeLoad:onMaterialBeforeLoad,panelHeight:150,editable:true,valueField:'MATERIAL_CODE_S',textField:'MATERIAL_CODE_S',selectOnNavigation:false,limitToList:true,
                    onSelect:onMaterialSelect_right}}"><spring:message code="productiondayplan.column.material_code_right_s" /></th>
                    <!-- 早班计划量(左) -->
                    ...
                    <!-- 机台条码(左) -->
                    <th data-options="field:'equip_code_left_s',hidden:true,width:120,editor:{type:'textbox',options:{icons:[],editable:false}}"><spring:message code="productiondayplan.column.equip_code_left_s" /></th>
                    <!-- 机台条码(右) -->
                    <th data-options="field:'equip_code_right_s',hidden:true,width:120,editor:{type:'textbox',options:{icons:[],editable:false}}"><spring:message code="productiondayplan.column.equip_code_right_s" /></th>
                    <!-- 物料名称(左) -->
                    ...
                    <!-- 胎胚品号(左) -->
                    <th data-options="field:'specification_left_s',width:200,editor:{type:'combobox',options:{required:true,onChange:onMaterialVer_left,editable:false,valueField:'specification_left_s',textField:'specification_left_s',onSelect:onStageSelect_left}}"><spring:message code="productiondayplan.column.specification_left_s" /></th>
                    <!-- 胎胚品号(右) -->
                    <th data-options="field:'specification_right_s',width:200,editor:{type:'combobox',options:{required:true,onChange:onMaterialVer_right,editable:false,valueField:'specification_left_s',textField:'specification_right_s',onSelect:onStageSelect_right}}"><spring:message code="productiondayplan.column.specification_right_s" /></th>
                    ...
                    <!-- 胎胚规格(右) -->
                    <th data-options="field:'spec_right_s',formatter:specFormatter2,width:120,editor:{type:'textbox',options:{required:true}}"><spring:message code="productiondayplan.column.spec_right_s" /></th>
                    ...
                    <!-- 工艺配方ID硫化 -->
                    <th data-options="field:'processbom_index_curing_s',hidden:false,width:120,editor:{type:'textbox',options:{editable:false,icons:[],required:true}}"><spring:message code="工艺配方ID硫化(左)" /></th>
                    
                     <!-- 工艺配方ID成型 -->
                    <th data-options="field:'processbom_index_build_s',hidden:false,width:120,editor:{type:'textbox',options:{editable:false,icons:[],required:true}}"><spring:message code="工艺配方ID成型(右)" /></th>
                     <%-- <!-- 日完成量(左) -->
