...
<body class="easyui-layout" fit="true"> 
   ...
   <jsp:include page="../../../../inc/export.jsp">
		...
		<jsp:param name="handlerClass" value="com.bluebirdme.mes.linglong.lh.ExcelHandler.WorkOrderResult2ExportHandler" />
		<jsp:param name="serviceName" value="WorkOrderResultServiceImpl2" />
