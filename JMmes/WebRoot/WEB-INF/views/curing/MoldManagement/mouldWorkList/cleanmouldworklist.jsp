...
<%@ include file="cleanmouldworklist.js.jsp"%>
...
<body class="easyui-layout" fit="true"> 
    <div data-options="region:'center',split:true,border:false" >
        <div id="WorkList_dg_toolbar">
            <form id="WorkList_search_form" class="form" >
                ...
                <input name="filter[moldcode_s]" id="moldcode_s" style="width:15%" type="text" class="easyui-textbox" data-options="label:''" >
                <!-- 机台编码 -->
                <spring:message code="worklist.column.machinecode_s" />:
                <input name="filter[machinecode_s]" id="machinecode_s" like="true" style="width:15%" type="text" class="easyui-textbox" data-options="label:''" >
                <!-- 开始时间 -->
        ...
        <table id="worklist_dg" class="easyui-datagrid" style="width:100%"
            ...
            <thead>
                <tr>
                    ...
                    <!-- 模具条码 -->
                    <th data-options="field:'moldcode_s',width:80,editor:{type:'textbox'}"><spring:message code="worklist.column.moldcode_s" /></th>
                    <!-- 机台编码 -->
                   ...
                   <!-- 机台作业类型  1模具换上，2换胶囊，3洗模 4 模具换下 5模具修理6组装 -->
                    ...
                    <!-- 作业人 -->
                    <th data-options="field:'execution_operator',width:80,editor:{type:'textbox'}"><spring:message code="worklist.column.execution_operator_s" /></th>  
                </tr>
            </thead>
        </table>
    </div>
 ...
 <!-- 	导出-->    
	<jsp:include page="../../../../inc/export.jsp">
		...
		<jsp:param name="handlerClass" value="com.bluebirdme.mes.linglong.lh.ExcelHandler.MouldWorkListExportHandler" />
