<!-- 
    ...
    作者      :孙尊龙
    时间      :2020-05-22 13:45:20
    页面名称:硫化报产固化，sap上报数据
    文件关联:
        PatchWorkOrderResult.java
        PatchWorkOrderResultController.java
        PatchWorkOrderResultServiceImpl.java
        PatchWorkOrderResultServiceImpl.xml
 -->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../../inc/meta.jsp"%>
<%@ include file="patchworkorderresulttosap.js.jsp"%>
<script type="text/javascript" src="dict/302,253,281.js"></script>
        ...
        <table id="workorderresult_dg" class="easyui-datagrid" style="width:100%"
            ...
            <thead>
                <tr>
                    ...
                    <!-- 轮胎条码-->
                    <th data-options="field:'tyre_barcode_s',editor:{type:'textbox'}"><spring:message code="workorderresultprint.column.tyre_barcode_s" /></th>
                    <!-- 补录原因-->
                    <th formatter="codeFormatter" data-options="field:'spare7_s',editor:{type:'textbox'}"><spring:message code="patchcuringwork.column.patchreason_s" /></th>
                 	<!-- 班次-->
             ...
             <table class="easyui-datagrid" style="width:100%" id="detail_dg"
	            ...
	            <thead>
	                <tr>
	                    ...
	                    <!-- 硫化质量等级 -->
						<th formatter="codeFormatter" data-options="field:'spare5_s',sortable:true,editor:{type:'textbox'}"><spring:message code="workorderresultprint.column.spare5_s" /></th>
						<!-- 机台编码 -->
	                    ...
	                    <!-- 是否补硫化 1：是 0：否 -->
                        <th formatter="stateFormatter" data-options="field:'patch_curingflag_s',editor:{type:'textbox'}"><spring:message code="workorderresult.column.patch_curingflag_s" /></th>
	                </tr>
	            </thead>
	        </table>
    </div>
