...
<script type="text/javascript">
    ...
    $(function(){
		...
		opts.url = 'curing/ProductionManagement/patch_sap_return_result/searchReplenishData';
    	ext.easyui.grid.search("sapreturnresult_dg","SapReturnResult_search_form");
    });
    //固化按钮
    function curing(){
    	...
    	debugger
    	ext.ajax.sendJson("curing/ProductionManagement/patch_sap_return_result/guhua",{
    		selectedrows : rows,
			begintime : beginTime,
			endtime : endTime
    	}, function(data){
  ...
  //明细按钮
    function productionDetail(){
    	...
    	beginTime= $('#start_time').datetimebox('getValue');
    	endTime=$('#end_time').datetimebox('getValue');
    	ext.ajax.sendJson("curing/ProductionManagement/patch_sap_return_result/productionDetail",{
    		   begintime:beginTime,
    		   endtime:endTime,
