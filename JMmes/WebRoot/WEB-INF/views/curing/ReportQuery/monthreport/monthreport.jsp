...
<%@ include file="monthreport.js.jsp"%>
    ...
    <div data-options="region:'center',split:true,border:false" >
        <div id="MesSapProduction_dg_toolbar2">
            <form id="messapproduction_search_form" class="form" >
				...
				<auth:button code="SRR_REPORT_EXPORT"><a class="easyui-linkbutton btn-deep-blue" data-options="iconCls:'icon-excel'" onclick="$_export()">
