...
作者      :孙尊龙
时间      :2020-05-18 11:45:20
页面名称:硫化异常固化，sap上报数据
文件关联:
Abnormal.java
AbnormalController.java
AbnormalServiceImpl.java
AbnormalServiceImpl.xml
-->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../../inc/meta.jsp"%>
<%@ include file="abnormal.js.jsp"%>
...
<div data-options="region:'center',split:true,border:false" >
    <div id="Abnormal_dg_toolbar">
        <form id="Abnormal_search_form" class="form" >
    ...
    <table id="abnormal_dg" class="easyui-datagrid" style="width:100%"
           data-options="
                fit:true,
                fitColumns:false,
                pagination:true,
...
<!-- 明细窗口 -->
<div id="abnormal_detail_dg" class="easyui-dialog" title="明细查询窗口" style="width:900px;height:400px;"
     data-options="
                closed:true
            ">
