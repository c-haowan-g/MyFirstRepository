...
<%@ include file="messapproduction.js.jsp"%>
...
<%--			</auth:button>--%>
	...
	<div id="report_dlg" title="<spring:message code="button.curing" />" class="easyui-dialog" style="width:90%;height:90%;"
		data-options="
                ...
                onOpen:function(){
                    $('#reportaddOrEditWin').attr('src','view?page=curing/ReportQuery/curingProductionToSap/workorderresulttosap&factory='+factory);
                }
            ">
	...
	<div id="reflush_dlg" title="<spring:message code="button.lhcuring" />" class="easyui-dialog" style="width:90%;height:90%;"
		data-options="
                ...
                onOpen:function(){
                 $('#reflushaddOrEditWin').attr('src','view?page=curing/ReportQuery/curingProductionToSap/sapreturnresulttosap&factory='+factory);
                }
            ">
