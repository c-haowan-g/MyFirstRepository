...
<%@ include file="mixdayplancopyjl.js.jsp"%>
            ...
            <thead>
                <tr>
                 ...
                 <tr> 
                    ...
                    <!-- 配方基本信息 -->
                    <!-- 密炼生成配方编号 -->
                    <th data-options="field:'mixrecipe_recipe_code_s',width:130"><spring:message code="plan.column.mixrecipe_recipe_code_s" /></th>
                    <!-- 密炼配方BOM版本 -->
