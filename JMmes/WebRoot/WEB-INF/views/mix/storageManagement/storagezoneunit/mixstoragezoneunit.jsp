...
<%@ include file="mixstoragezoneunit.js.jsp"%>
<script type="text/javascript" src="dict/112,308,062.js"></script>
...
<div data-options="region:'center'">
   <div id="Halfpart_zone_dg_toolbar">
      <form id="Halfpart_zone_search_form" class="form" >
         ...
         :&emsp;<input name="filter[description]" id="description" type="text" like=true class="easyui-combotree" 
            data-options="label:'',
                          required:false,
				          panelHeight:200,
				          url:'dict/code/062',
