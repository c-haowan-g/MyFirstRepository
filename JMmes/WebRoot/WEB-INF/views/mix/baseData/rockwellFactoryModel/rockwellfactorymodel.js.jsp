...
<script type="text/javascript">
     ...
     */
    var filter = function(){
    	var url = "mix/baseData/rockWellFactoryModel/factorymodeltree";
    	ext.ajax.get(url, function(data) {
			$('#tree_model').tree('loadData', data);
		});
    };
    ...
    function selecttree(node){
		...
		$.ajax({
	 		url:"mix/baseData/rockWellFactoryModel/getTreeNodeInfo?level="+treelevel+"&key="+currentNode.id,
	 		type:"get",
	 		dataType:"json",
	 		async:false,
    ...
    function addsave() {
		...
		$.ajax({
            url:'mix/baseData/rockWellFactoryModel/add',
	 		type:"post",
	 		dataType:"json",
			...
			contentType:'application/json',
	 		...
	 		success:function(data){
	 			...
	 			if(data.id == null) {
	 				ext.tip.error("节点ID重复，请删除该节点重新添加");
	 			}else {
	 				ext.tip.suc("操作成功");
	 			}
    ...
    function editsave(){
		...
		list_map.description = modelDescription;
		$.ajax({
	 		url:'mix/baseData/rockWellFactoryModel/edit',
	 		type:"post",
	 		dataType:"json",
	 		data : JSON.stringify(list_map),
			contentType:'application/json',
	...
	function removeconfirm(){
		...
		$.ajax({
	 		url:'mix/baseData/rockWellFactoryModel/remove',
	 		type:"post",
	 		dataType:"json",
	 		data : JSON.stringify(list_map),
			contentType:'application/json',
