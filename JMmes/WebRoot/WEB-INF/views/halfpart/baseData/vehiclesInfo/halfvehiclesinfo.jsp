...
<%@ include file="halfvehiclesinfo.js.jsp"%>
        ...
        <table id="vehiclesinfo_dg" class="easyui-datagrid" style="width:100%"
            ...
            <thead>
                <tr>
                    ...
                    <!-- 类型 ：载具基础数据 102，工装基础数据103 -->
                    <th data-options="field:'vehicles_type_s',formatter:codeFormatter,align:'center',width:150,editor:{type:'combobox',
                                 options:{
                                 textField:'DICTNAME_S',
								valueField:'DICTCODE_S',
                           		 required:true, 
                    ...
                    <th data-options="field:'spare1_s',formatter:codeFormatter,align:'center',width:150,editor:{type:'combobox',
                                 options:{
                                 textField:'DICTNAME_S',
								valueField:'DICTCODE_S',
                           		 required:false, 
