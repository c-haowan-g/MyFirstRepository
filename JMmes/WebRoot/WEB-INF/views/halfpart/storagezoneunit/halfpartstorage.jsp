...
<!-- 主页面 --> 
<div id="main_page" data-options="region:'center',split:true,border:true">
   <div id="Halfpart_storage_dg_toolbar">
      ...
      <auth:button code="HALFPART_STORAGE_ZONE"><a class="easyui-linkbutton btn-green" data-options="iconCls:'icon-add'" onclick="zone_open()"><spring:message code="storage.zone" /></a></auth:button>
      <auth:button code="HALFPART_STORAGE_UNIT"><a class="easyui-linkbutton btn-green" data-options="iconCls:'icon-add'" onclick="unit_open()"><spring:message code="storage.unit" /></a></auth:button>
   </div> 
   <table id="halfpart_storage_dg"  class="easyui-datagrid">
       ...
       <tr>
          ...
          <!-- 库区条码-->
          <th data-options="field:'storage_zone_name',sortable:true,width:100">库区条码</th>
          <!-- 库区名称 -->
          <th data-options="field:'description',sortable:true,width:100">库区名称</th>
          <!-- 库区逻辑条码-->
          <th data-options="field:'inventory_barcode_s',sortable:true,hidden:true,width:100">库区逻辑条码</th>
          <!-- 物料组uda -->
          <th data-options="field:'materialgroup_s',formatter:materialGroupFormatter,sortable:true,width:100">物料组</th>
          <!-- 是否包含子库uda -->
          <th data-options="field:'is_allow_child_stock_s',formatter:yesFormatter,hidden:true,sortable:true,width:100">是否包含子库</th>
          <!-- 备注uda -->
          <th data-options="field:'remarks_s',sortable:true,width:100">备注</th>
          <!-- 操作人uda  -->
          <th data-options="field:'operater_s',sortable:true,width:100">操作人</th>
          <!-- 操作时间uda  -->
	      <th data-options="field:'operatetime_t',sortable:true,width:100">操作时间</th>
	   </tr>
	   </thead>
   </table>
</div>
  ...
  <table id="halfpart_storageunit_dg" class="easyui-datagrid" 
     data-options="
        ...
        <tr>
         ...
         <!-- 库位名称 -->
         <th data-options="field:'storage_unit_name',sortable:true,width:120,editor:{type:'textbox',
                           options:{
                                     required:true,
							         editable:true
                                   }}">库位名称</th>
         ...
         <!-- 当前库存 -->
         <th data-options="field:'current_storage_i',width:80,sortable:true,editor:{type:'textbox',options:{disabled:true}}">当前库存</th>
         <!-- 存放物料名称 -->
         <th data-options="field:'inventory_materialname_s',width:130,sortable:true,editor:{type:'combobox',
                           options:{ 
                                    editable:true,                          
