...
<script type="text/javascript">
    ...
    var saveChanges=path+"halfpart/baseData/halfpartMachineOutput/saveChanges";
    ...
    */
    ...
    var opts = $("#halfpartmachineoutputsearch_dg").datagrid("options");
        ...
        ext.easyui.grid.search("halfpartmachineoutputsearch_dg","HalfpartMachineOutputSearch_search_form");
    }
