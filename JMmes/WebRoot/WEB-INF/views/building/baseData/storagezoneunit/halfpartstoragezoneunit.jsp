      ...
      <form id="Halfpart_zone_search_form" class="form" >
         ...
         :&emsp;<input name="filter[category]" id="category" type="text" like=true class="easyui-combobox" 
          data-options="label:'',
                        ...
                        editable:true,
                        required:false,
                        url:'building/basedata/storagezonemanager/searchZoneName',
   ...
   <table id="halfpart_storagezone_dg"  class="easyui-datagrid"  
       ...
       <tr>
          ...
          <th data-options="field:'storage_type_s',width:150,formatter:codeFormatter,editor:{type:'combobox',options:{
                                panelWidth:'300',
                    			required:true,
                    			data:[{value:'227003',text:'胎胚平面库'},{value:'227006',text:'胎胚不合格库'},{value:'227004',text:'胎胚立体库'},{value:'227005',text:'成型机头库'}]
                    			}}">库区种类</th>   
   ...
   <div id="halfpart_unit_manage_dg" class="easyui-dialog" title="库位维护"  
     ...
     <table id="halfpart_storageunit_dg" class="easyui-datagrid" 
           ...
           <tr>
              ...
              <!-- 存放物料名称 -->
              <th data-options="field:'inventory_materialname_s',width:100,sortable:true,hidden:true,editor:{type:'textbox',options:{}}"><spring:message code="sapproductionplan.column.material_name_s" /></th>
              <!-- 存放物料编码 -->
              <th data-options="field:'inventory_materialcode_s',width:100,sortable:true,hidden:true,editor:{type:'textbox',options:{}}"><spring:message code="sapproductionplan.column.material_code_s" /></th>
              <!-- 启用/停用 -->
