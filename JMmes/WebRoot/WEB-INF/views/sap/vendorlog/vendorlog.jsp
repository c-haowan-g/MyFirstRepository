<!-- 
    ...
    作者      :周清玉
    时间      :2018-10-17 14:17:21 
    页面名称:供应商信息表历史
    文件关联:
        VendorLog.java
        VendorLogController.java
        VendorLogServiceImpl.java
        VendorLogServiceImpl.xml
 -->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../inc/meta.jsp"%>
<%@ include file="vendorlog.js.jsp"%>
<script type="text/javascript" src="dict/-303.js"></script>

<body class="easyui-layout" fit="true"> 
    <div data-options="region:'center',split:true,border:false" >
        <div id="VendorLog_dg_toolbar">
            <form id="VendorLog_search_form" class="form" >
                <!-- 供应商编号 -->
                ...
                <input name="filter[contactor_s]" id="contactor_s" like="true" type="text" class="easyui-textbox" data-options="label:''" >
               	<!-- 采购组织 -->
               	&emsp;<spring:message code="vendor.column.pur_org_s" />:
                ...
                <!-- 联系电话 -->
                &emsp;<spring:message code="vendor.column.tel1_s" />:
                ...
                &emsp;&emsp;<spring:message code="tip.to" />&emsp;&emsp;&ensp;<input name="filter[end_time]" id="end_time" type="text" class="easyui-datetimebox" data-options="label:''" >
                <a class="easyui-linkbutton btn-yellow" data-options="iconCls:'icon-search'" onclick="filter()"><spring:message code="button.search" /></a>
            </form> 
        </div>
        <table id="vendorlog_dg" class="easyui-datagrid" style="width:100%"
            data-options="  
                fit:true,
                fitColumns:true,
                pagination:true,
