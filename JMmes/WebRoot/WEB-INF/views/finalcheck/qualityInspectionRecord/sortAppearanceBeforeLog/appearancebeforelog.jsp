<!-- 
    ...
    作者      :时永良
    时间      :2019-01-07 11:38:44 
    页面名称:质检外观前分拣履历表
    文件关联:
        SortAppearanceBeforeLog.java
        SortAppearanceBeforeLogController.java
        SortAppearanceBeforeLogServiceImpl.java
        SortAppearanceBeforeLogServiceImpl.xml
 -->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../../inc/meta.jsp"%>
<%@ include file="appearancebeforelog.js.jsp"%>
<script type="text/javascript" src="dict/252,259,260,253.js"></script>
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<div id="SortAppearanceLog_dg_toolbar">
			<form id="SortAppearanceLog_search_form" class="form">
				<!-- 轮胎条码：MainTyre 表 BARCODE -->
				<input name="filter[proess_i]" id="proess_i" value="252008" type="hidden">
		...
		<table id="sortappearancelog_dg" class="easyui-datagrid" style="width:100%"
			data-options="  
                fit:true,
                fitColumns:false,
                pagination:true,
                rownumbers: true,
                singleSelect: false,
                toolbar: '#SortAppearanceLog_dg_toolbar',
                url: '',
                striped:true,
                method: 'get' ,
			...
			<thead>
				<tr>
					...
					<!-- 工控下发是否成功：0-成功、1-失败 -->
					<th data-options="field:'writein_s',formatter:WriteinFormatter,editor:{type:'textbox'}"><spring:message code="sortappearancelog.column.writein_s" /></th>
					<!-- 工控下发备注 -->
					...
					<!-- 操作时间 -->
                    <th data-options="field:'sorttime_t',editor:{type:'textbox'}"><spring:message code="sortappearancelog.column.sorttime_t" /></th>
                   
					<!-- 创建人 -->
					<th data-options="field:'username',width:80,editor:{type:'textbox'}"><spring:message code="sortappearancelog.column.created_by_s" /></th>
					<!-- 创建时间 -->
					<th data-options="field:'created_time_t',editor:{type:'textbox'}"><spring:message code="sortappearancelog.column.created_time_t" /></th>
	 ...
	 <jsp:include page="../../../../inc/export.jsp">
		...
		<jsp:param name="formId" value="SortAppearanceLog_search_form" />
		<jsp:param name="datagridId" value="sortappearancelog_dg" />
		<jsp:param name="handlerClass" value="com.bluebirdme.mes.linglong.finalcheck.excel.SortAppearanceBeforeLogExportHandler" />
		<jsp:param name="serviceName" value="SortAppearanceBeforeLogServiceImpl" />
	</jsp:include>
</body>
</html>
