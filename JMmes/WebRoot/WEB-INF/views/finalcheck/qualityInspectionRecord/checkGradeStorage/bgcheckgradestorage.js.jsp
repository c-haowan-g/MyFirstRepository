 ...
 /**
    ...
    var filter=function(){
    	...
    	if(line == true && material == false){
            $("#checkgradestorage_dg").datagrid("options").url="finalcheck/qualityInspectionRecord/bgcheckgradegradestorage/bgcheckgradegradestorage/searchInit2";
    	...
    	if(line == false && material == true){
            $("#checkgradestorage_dg").datagrid("options").url="finalcheck/qualityInspectionRecord/bgcheckgradegradestorage/bgcheckgradegradestorage/searchInit3";
    		ext.easyui.grid.search("checkgradestorage_dg","Checkgradestorage_search_form");
    		$('#checkgradestorage_dg').datagrid({ 
    			columns:[[
                	{field:'atr_key',checkbox:true},
