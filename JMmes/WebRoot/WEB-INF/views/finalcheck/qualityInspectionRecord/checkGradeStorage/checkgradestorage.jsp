<!-- 
    ...
    作者      :徐秉正
    时间      :2020-09-02 15:37:03 
    页面名称:机检废次品入库确认表
    文件关联:
        Checkgradestorage.java
        CheckgradestorageController.java
        CheckgradestorageServiceImpl.java
        CheckgradestorageServiceImpl.xml
 -->
<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
<%@ include file="../../../../inc/meta.jsp"%>
<%@ include file="checkgradestorage.js.jsp"%>
...
<body class="easyui-layout" fit="true"> 
    <div data-options="region:'center',split:true,border:false" >
        <div id="Checkgradestorage_dg_toolbar">
            ...
            <auth:button code="ZJ_ZJLL_QUAN_GANG_Checkgradestorage_EXPORT"><a class="easyui-linkbutton btn-deep-blue" data-options="iconCls:'icon-excel-export'" onclick="$_export()"><spring:message code="button.export" /></a></auth:button>
            　
            　
        </div>
	...
	<jsp:include page="../../../../inc/export.jsp">
		...
		<jsp:param name="handlerClass" value="com.bluebirdme.mes.linglong.finalcheck.excel.CheckgradestorageExportHandler" />
		<jsp:param name="serviceName" value="CheckgradestorageServiceImpl" />
	</jsp:include>
</body>
</html>
