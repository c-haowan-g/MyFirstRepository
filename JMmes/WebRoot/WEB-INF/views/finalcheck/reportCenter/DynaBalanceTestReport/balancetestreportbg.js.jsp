...
<script type="text/javascript">
	...
	//初始化表格
	function intTable(){
		   $("#dynamicbalancetestreport_dg").datagrid("options").url="finalcheck/reportCenter/BalanceTestReportBG/filter";
   ...
   /*  //禁止选中合计行
	...
	function ExcelExport() {
	    ...
	    if (node == "") {
    		...
    		$.ajax({
    			url : "finalcheck/reportCenter/BalanceTestReportBG/searchBy?s_factory_s="+factory+"&"+param_get,
    			type : 'get',
    			dataType : 'json',
    			async : false,
	    ...
	    var CheckTotal=false;//检测是否选择合计行，true选中,false未选中
   		...
   		if(!CheckTotal){
   		//导出添加合计行
   	 		var newJson={curingspeccode_s:"",description:"<spring:message code="dynabalancecheresultprint.column.total" />",speccount:""+speccount+"",dpha1:""+dpha1+"",dpha1pinlv:""+dpha1pinlv+"",tdda1:""+tdda1+"",tdda1pinlv:""+tdda1pinlv+"",jyxa1:""+jyxa1+"",jyxa1pinlv:""+jyxa1pinlv+"",a1:""+a1+"",a1pinlv:""+a1pinlv+"",dpha:""+dpha+"",dphapinlv:""+dphapinlv+"",tdda:""+tdda+"",tddapinlv:""+tddapinlv+"",jyxa:""+jyxa+"",jyxapinlv:""+jyxapinlv+"",a:""+a+"",apinlv:""+apinlv+"",dpha0:""+dpha0+"",dpha0pinlv:""+dpha0pinlv+"",tdda0:""+tdda0+"",tdda0pinlv:""+tdda0pinlv+"",jyxa0:""+jyxa0+"",jyxa0pinlv:""+jyxa0pinlv+"",a0:""+a0+"",a0pinlv:""+a0pinlv+"",dphd:""+dphd+"",dphdpinlv:""+dphdpinlv+"",tddd:""+tddd+"",tdddpinlv:""+tdddpinlv+"",jyxd:""+jyxd+"",jyxdpinlv:""+jyxdpinlv+"",erji:""+erji+"",erjipinlv:""+erjipinlv+""}; 
   	 		node.push(newJson); 	
   		}
