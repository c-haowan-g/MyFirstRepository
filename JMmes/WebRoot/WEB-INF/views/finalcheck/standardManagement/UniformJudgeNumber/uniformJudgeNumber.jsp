...
<%@ include file="uniformJudgeNumber.js.jsp"%>
     ...
     <div id="JudgeNumber_dg_toolbar">
            <form id="JudgeNumber_search_form" class="form" >
	            <td class="columnTitle">
                 <input name="filter[enttype_s]" id="enttype_s"  type="hidden"  value="254005" data-options="label:''" >
				</td>
				 <td class="columnTitle">
							...
							<tr>
								...
								<!-- 动平衡检测结果质量等级-->
								 <th data-options="field:'cegradecode_s',width:80,formatter:codeFormatter,editor:{type:'combobox',options:
	                                ...
	                                required:true,
	                                method:'get',
	                                url:'finalcheck/reportCenter/JudgeNumberGrade/comboxUniformGrade'}}"><spring:message code="judgenumbergrade.column.cegradecode_s" /></th>
								<!-- 动平衡机下发等级（1，2，3，4，5..） -->
								<th data-options="field:'machinegradecode_s',width:80,editor:{type:'combobox',options:{valueField:'DBCODE',
	                                ...
	                                required:true}}"><spring:message code="judgenumbergrade.column.uniformmachinegradecode_s" /></th>
								</tr>
						</thead>
					</table>  
	          </div> 
